...
<input type="hidden" name="userid" id="userid" value="{{$user.userid}}" />
    <table id="user-base" border="0" cellspacing="2" cellpadding="3" class="table-form table-form-f12" style="margin-top:20px;">
        ...
        <tr>
            ...
            <td>
                <p><input name="maxndquota" type="text" class="text" size="10" value="{{math|round:1 equation="x/1000000" x=$user.maxndquota}}" style="ime-mode:disabled" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)" />&nbsp;MB, 已使用 <span class="red">{{$quotaused|format_file_size}}</span></p>
            </td>
        </tr>
        <tr>
            <th align="right"> </th>
