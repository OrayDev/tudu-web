...
ScreenCapture.prototype = {
    ...
    createActiveX: function(key, install) {
        ...
        if (TOP.Browser.isIE) {
            ...
            var obj = $('<embed type="application/x-oray-npffadapter" codebase="'+ScreenCapture.activex[key].codebase+'" classid="CLSID:'+ScreenCapture.activex[key].classid+'" pluginspage="https://addons.mozilla.org/zh-CN/firefox/addon/sunlogin-controller-plugin/" width="1" height="1"></embed>');
