        ...
        render: function (container,holder) {
            ...
            if (container) {
                ...
                if (options.customDomain && document.domain != location.hostname) {
                    ...
                    container.style.width = '100%'; //options.initialFrameWidth+ 'px';
    ...
    EditorUI.prototype = {
        ...
        _scale:function () {
            ...
            function up() {
                if (isMouseMove) {
                    isMouseMove = false;
                    editor.ui._actualFrameWidth = '100%'; //scalelayer.offsetWidth - 2;
                    editorHolder.style.width = '100%'; //editor.ui._actualFrameWidth + 'px';
        ...
        editor.render = function (holder) {
            ...
            utils.domReady(function () {
                ...
                function renderUI() {
                    ...
                    editor.container.style.width  = '100%'; //opt.initialFrameWidth+ 'px';
