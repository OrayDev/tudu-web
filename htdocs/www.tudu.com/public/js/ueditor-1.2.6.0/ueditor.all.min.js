...
b){var c=a.ownerDocument;if(p.ie&&b==a.nodeValue.length){var d=c.createTextNode("");return f.insertAfter(a,d)}d=a.splitText(b);p.ie8&&(c=c.createTextNode(""),f.insertAfter(d,c),f.remove(c));return d},isWhitespace:function(a){return!RegExp("[^ \t\n\r"+f.fillChar+"]").test(a.nodeValue)},getXY:function(a){for(var b=0,c=0;a.offsetParent;)c+=a.offsetTop,b+=a.offsetLeft,a=a.offsetParent;return{x:b,y:c}},on:function(a,b,c){var d=n.isArray(b)?b:[b],e=d.length;if(e)for(;e--;)if(b=d[e],a.addEventListener)a.addEventListener(b,
c,!1);else{c._d||(c._d={els:[]});var g=b+c.toString(),f=n.indexOf(c._d.els,a);if(!c._d[g]||-1==f)-1==f&&c._d.els.push(a),c._d[g]||(c._d[g]=function(a){return c.call(a.srcElement,a||window.event)}),a.attachEvent("on"+b,c._d[g])}a=null},un:function(a,b,c){var d=n.isArray(b)?b:[b],e=d.length;if(e)for(;e--;)if(b=d[e],a.removeEventListener)a.removeEventListener(b,c,!1);else{var g=b+c.toString();try{a.detachEvent("on"+b,c._d?c._d[g]:c)}catch(f){}c._d&&c._d[g]&&(b=n.indexOf(c._d.els,a),-1!=b&&c._d.els.splice(b,
...
0,e;e=b[d++];)if(e.parentNode&&!f.isBookmarkNode(e))if("span"==e.tagName.toLowerCase()){if(a===e.parentNode&&(f.trimWhiteTextNode(a),1==a.childNodes.length)){a.style.cssText=e.style.cssText+";"+a.style.cssText;f.remove(e,!0);continue}e.style.cssText=a.style.cssText+";"+e.style.cssText;if(c){var g=c.style;if(g)for(var g=g.split(";"),h=0,j;j=g[h++];)e.style[n.cssStyleToDomStyle(j.split(":")[0])]=j.split(":")[1]}f.isSameStyle(e,a)&&f.remove(e,!0)}else f.isSameElement(a,e)&&f.remove(e,!0)},getElementsByTagName:function(a,
b,c){if(c&&n.isString(c)){var d=c;c=function(a){return f.hasClass(a,d)}}b=n.trim(b).replace(/[ ]{2,}/g," ").split(" ");for(var e=[],g=0,h;h=b[g++];){h=a.getElementsByTagName(h);for(var j=0,l;l=h[j++];)(!c||c(l))&&e.push(l)}return e},mergeToParent:function(a){for(var b=a.parentNode;b&&t.$removeEmpty[b.tagName];){if(b.tagName==a.tagName||"A"==b.tagName){f.trimWhiteTextNode(b);if("SPAN"==b.tagName&&!f.isSameStyle(b,a)||"A"==b.tagName&&"SPAN"==a.tagName)if(1<b.childNodes.length||b!==a.parentNode){a.style.cssText=
...
j,j=f.getNextDomNode(j,1==j.nodeType,null,function(b){return t[a][b.tagName]});var h=k.setEndAfter(l).extractContents(),m;if(c&&0<c.length){var n;n=m=c[0].cloneNode(!1);for(var p=1,E;E=c[p++];)m.appendChild(E.cloneNode(!1)),m=m.firstChild}else m=k.document.createElement(a);b&&f.setAttributes(m,b);m.appendChild(h);k.insertNode(c?n:m);var s;"span"==a&&b.style&&/text\-decoration/.test(b.style)&&(s=f.findParentByTagName(m,"a",!0))?(f.setAttributes(s,b),f.remove(m,!0),m=s):(f.mergeSibling(m),f.clearEmptySibling(m));
f.mergeChild(m,b);h=f.getNextDomNode(m,!1,g);f.mergeToParent(m);if(j===e)break}else h=f.getNextDomNode(h,!0,g);return this.moveToBookmark(d)},removeInlineStyle:function(a){if(this.collapsed)return this;a=n.isArray(a)?a:[a];this.shrinkBoundary().adjustmentBoundary();for(var b=this.startContainer,c=this.endContainer;;){if(1==b.nodeType){if(-1<n.indexOf(a,b.tagName.toLowerCase()))break;if("body"==b.tagName.toLowerCase()){b=null;break}}b=b.parentNode}for(;;){if(1==c.nodeType){if(-1<n.indexOf(a,c.tagName.toLowerCase()))break;
...
b!==d.end;)c=f.getNextDomNode(b,!0,function(a){return 1==a.nodeType}),-1<n.indexOf(a,b.tagName.toLowerCase())&&f.remove(b,!0),b=c;return this.moveToBookmark(d)},getClosedNode:function(){var a;if(!this.collapsed){var b=this.cloneRange().adjustmentBoundary().shrinkBoundary();if(vb(b)&&(b=b.startContainer.childNodes[b.startOffset])&&1==b.nodeType&&(t.$empty[b.tagName]||t.$nonChild[b.tagName]))a=b}return a},select:p.ie?function(a,b){var c;this.collapsed||this.shrinkBoundary();var d=this.getClosedNode();
...
!1,!0);f.isEmptyNode(b.body)&&(b.body.innerHTML="<p>"+(p.ie?"":"<br/>")+"</p>");c.focus&&setTimeout(function(){b.focus(b.options.focusInEnd);!b.options.autoClearinitialContent&&b._selectionChange()},0);b.container||(b.container=this.iframe.parentNode);c.fullscreen&&b.ui&&b.ui.setFullScreen(!0);try{b.document.execCommand("2D-position",!1,!1)}catch(h){}try{b.document.execCommand("enableInlineTableEditing",!1,!1)}catch(j){}try{b.document.execCommand("enableObjectResizing",!1,!1)}catch(l){}b._bindshortcutKeys();
b.isReady=1;b.fireEvent("ready");c.onready&&c.onready.call(b);if(!p.ie)f.on(b.window,["blur","focus"],function(a){if("blur"==a.type){b._bakRange=b.selection.getRange();try{b.selection.getNative().removeAllRanges()}catch(c){}}else try{b._bakRange&&b._bakRange.select()}catch(d){}});p.gecko&&10902>=p.version&&(b.body.contentEditable=!1,setTimeout(function(){b.body.contentEditable=!0},100),setInterval(function(){b.body.style.height=b.iframe.offsetHeight-20+"px"},100));!c.isShow&&b.setHide();c.readonly&&
b.setDisabled()},sync:function(a){(a=a?document.getElementById(a):f.findParent(this.iframe.parentNode,function(a){return"FORM"==a.tagName},!0))&&sa(a,this)},setHeight:function(a){a!==parseInt(this.iframe.parentNode.style.height)&&(this.iframe.parentNode.style.height=a+"px");this.document.body.style.height=a-20+"px"},addshortcutkey:function(a,b){var c={};b?c[a]=b:c=a;n.extend(this.shortcutkeys,c)},_bindshortcutKeys:function(){var a=this,b=this.shortcutkeys;a.addListener("keydown",function(c,d){var e=
d.keyCode||d.which,g;for(g in b)for(var h=b[g].split(","),j=0,l;l=h[j++];){l=l.split(":");var k=l[0];l=l[1];if(/^(ctrl)(\+shift)?\+(\d+)$/.test(k.toLowerCase())||/^(\d+)$/.test(k))if("ctrl"==RegExp.$1&&(d.ctrlKey||d.metaKey)&&(""!=RegExp.$2?d[RegExp.$2.slice(1)+"Key"]:1)&&e==RegExp.$3||e==RegExp.$1)-1!=a.queryCommandState(g,l)&&a.execCommand(g,l),f.preventDefault(d)}})},getContent:function(a,b,c,d,e){a&&n.isFunction(a)&&(b=a,a="");if(b?!b():!this.hasContents())return"";this.fireEvent("beforegetcontent");
b=UE.htmlparser(this.body.innerHTML,d);this.filterOutputRule(b);this.fireEvent("aftergetcontent",a);return b.toHtml(e)},getAllHtml:function(){var a=[];this.fireEvent("getAllHtml",a);if(p.ie&&8<p.version){var b="";n.each(this.document.styleSheets,function(a){b+=a.href?'<link rel="stylesheet" type="text/css" href="'+a.href+'" />':"<style>"+a.cssText+"</style>"});n.each(this.document.getElementsByTagName("script"),function(a){b+=a.outerHTML})}return"<html><head>"+(this.options.charset?'<meta http-equiv="Content-Type" content="text/html; charset='+
this.options.charset+'"/>':"")+(b||this.document.getElementsByTagName("head")[0].innerHTML)+a.join("\n")+"</head><body "+(I&&9>p.version?'class="view"':"")+">"+this.getContent(null,null,!0)+"</body></html>"},getPlainTxt:function(){var a=RegExp(f.fillChar,"g"),b=this.body.innerHTML.replace(/[\n\r]/g,""),b=b.replace(/<(p|div)[^>]*>(<br\/?>|&nbsp;)<\/\1>/gi,"\n").replace(/<br\/?>/gi,"\n").replace(/<[^>/]+>/g,"").replace(/(\n)?<\/([^>]+)>/g,function(a,b,e){return t.$block[e]?"\n":b?b:""});return b.replace(a,
"").replace(/\u00a0/g," ").replace(/&nbsp;/g," ")},getContentTxt:function(){return this.body[p.ie?"innerText":"textContent"].replace(RegExp(f.fillChar,"g"),"").replace(/\u00a0/g," ")},setContent:function(a,b,c){this.fireEvent("beforesetcontent",a);a=UE.htmlparser(a);this.filterInputRule(a);a=a.toHtml();this.body.innerHTML=(b?this.body.innerHTML:"")+a;if("p"==this.options.enterTag)if(b=this.body.firstChild,!b||1==b.nodeType&&(t.$cdata[b.tagName]||"DIV"==b.tagName&&b.getAttribute("cdata_tag")||f.isCustomeNode(b))&&
b===this.body.lastChild)this.body.innerHTML="<p>"+(p.ie?"&nbsp;":"<br/>")+"</p>"+this.body.innerHTML;else for(var d=this.document.createElement("p");b;){for(;b&&(3==b.nodeType||1==b.nodeType&&t.p[b.tagName]&&!t.$cdata[b.tagName]);)a=b.nextSibling,d.appendChild(b),b=a;if(d.firstChild)if(b)b.parentNode.insertBefore(d,b),d=this.document.createElement("p");else{this.body.appendChild(d);break}b=b.nextSibling}this.fireEvent("aftersetcontent");this.fireEvent("contentchange");!c&&this._selectionChange();
this._bakRange=this._bakIERange=null;var e;p.gecko&&(e=this.selection.getNative())&&e.removeAllRanges();this.options.autoSyncData&&this.form&&sa(this.form,this)},focus:function(a){try{var b=this.selection.getRange();a?b.setStartAtLast(this.body.lastChild).setCursor(!1,!0):b.select(!0);this.fireEvent("focus")}catch(c){}},_initEvents:function(){var a=this,b=a.document,c=a.window;a._proxyDomEvent=n.bind(a._proxyDomEvent,a);f.on(b,"click contextmenu mousedown keydown keyup keypress mouseup mouseover mouseout selectstart".split(" "),
a._proxyDomEvent);f.on(c,["focus","blur"],a._proxyDomEvent);f.on(b,["mouseup","keydown"],function(b){"keydown"==b.type&&(b.ctrlKey||b.metaKey||b.shiftKey||b.altKey)||2!=b.button&&a._selectionChange(250,b)});var d=0,b=p.ie?a.body:a.document,e;f.on(b,"dragstart",function(){d=1});f.on(b,p.webkit?"dragover":"drop",p.webkit?function(){clearTimeout(e);e=setTimeout(function(){if(!d){var b=a.selection.getRange();if(b&&(b=b.getCommonAncestor())&&a.serialize){var c=a.serialize,e=c.filter(c.transformInput(c.parseHTML(c.word(b.innerHTML))));
b.innerHTML=c.toHTML(e)}}d=0},200)}:function(a){d||(a.preventDefault?a.preventDefault():a.returnValue=!1);d=0})},_proxyDomEvent:function(a){return this.fireEvent(a.type.replace(/^on/,""),a)},_selectionChange:function(a,b){var c=this,d=!1,e,g;p.ie&&(9>p.version&&b&&"mouseup"==b.type)&&!this.selection.getRange().collapsed&&(d=!0,e=b.clientX,g=b.clientY);clearTimeout(Bb);Bb=setTimeout(function(){if(c.selection.getNative()){var a;if(d&&"None"==c.selection.getNative().type){a=c.document.body.createTextRange();
...
setDisabled:function(a){var b=this;a=a?n.isArray(a)?a:[a]:[];"true"==b.body.contentEditable&&(b.lastBk||(b.lastBk=b.selection.getRange().createBookmark(!0)),b.body.contentEditable=!1,b.bkqueryCommandState=b.queryCommandState,b.queryCommandState=function(c){return-1!=n.indexOf(a,c)?b.bkqueryCommandState.apply(b,arguments):-1},b.fireEvent("selectionchange"))},disable:function(a){return this.setDisabled(a)},_setDefaultContent:function(a){this.body.innerHTML='<p id="initContent">'+a+"</p>";this.addListener("firstBeforeExecCommand focus",
...
if(this.children&&this.children.length)for(var c=0;b=this.children[c++];)if(b=Fb(b,a))return b},getNodesByTagName:function(a){a=n.trim(a).replace(/[ ]{2,}/g," ").split(" ");var b=[],c=this;n.each(a,function(a){if(c.children&&c.children.length)for(var e=0,f;f=c.children[e++];)Gb(f,a,b)});return b},getStyle:function(a){var b=this.getAttr("style");return!b?"":(a=b.match(RegExp(a+":([^;]+)","i")))&&a[0]?a[1]:""},setStyle:function(a,b){function c(a,b){d=d.replace(RegExp(a+":([^;]+;?)","gi"),"");b&&(d=
a+":"+n.unhtml(b)+";"+d)}var d=this.getAttr("style");d||(d="");if(n.isObject(a))for(var e in a)c(e,a[e]);else c(a,b);this.setAttr("style",d)},traversal:function(a){this.children&&this.children.length&&Hb(this,a);return this}};UE.htmlparser=function(a,b){function c(a,b){if(k[a.tagName]){var c=j.createElement(k[a.tagName]);a.appendChild(c);c.appendChild(j.createText(b))}else a.appendChild(j.createText(b))}function d(a,b,c){var e;if(e=l[b]){for(var f=a,h;"root"!=f.type;){if(n.isArray(e)?-1!=n.indexOf(e,
f.tagName):e==f.tagName){a=f;h=!0;break}f=f.parentNode}h||(a=d(a,n.isArray(e)?e[0]:e))}e=new j({parentNode:a,type:"element",tagName:b.toLowerCase(),children:t.$empty[b]?null:[]});if(c){for(f={};h=g.exec(c);)f[h[1].toLowerCase()]=n.unhtml(h[2]||h[3]||h[4]);e.attrs=f}a.children.push(e);return t.$empty[b]?a:e}var e=/<(?:(?:\/([^>]+)>)|(?:!--([\S|\s]*?)--\x3e)|(?:([^\s\/>]+)\s*((?:(?:"[^"]*")|(?:'[^']*')|[^"'<>])*)\/?>))/g,g=/([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g,
...
"thead","tfoot"],tbody:"table",th:"tr",thead:"table",tfoot:"table",caption:"table",li:["ul","ol"],dt:"dl",dd:"dl",option:"select"},k={ol:"li",ul:"li"},m,p=0,q=0,E=new j({type:"root",children:[]}),s=E;m=e.exec(a);){p=m.index;try{if(p>q&&c(s,a.slice(q,p)),m[3])s=d(s,m[3].toLowerCase(),m[4]);else if(m[1]){if("root"!=s.type){for(p=s;"element"==s.type&&s.tagName!=m[1].toLowerCase();)if(s=s.parentNode,"root"==s.type)throw s=p,"break";s=s.parentNode}}else m[2]&&s.children.push(new j({type:"comment",data:m[2],
parentNode:s}))}catch(A){}q=e.lastIndex}q<a.length&&c(s,a.slice(q));return E};var ha=function(a,b){switch(a.type){case "element":var c;if(c=b[a.tagName])if("-"===c)a.parentNode.removeChild(a);else if(n.isFunction(c)){var d=a.parentNode,e=a.getIndex();c(a);if(a.parentNode){if(a.children)for(c=0;e=a.children[c];)ha(e,b),e.parentNode&&c++}else for(c=e;e=d.children[c];)ha(e,b),e.parentNode&&c++}else{if((c=c.$)&&a.attrs){var e={},f;for(d in c){f=a.getAttr(d);if("style"==d&&n.isArray(c[d])){var h=[];n.each(c[d],
function(b){var c;(c=a.getStyle(b))&&h.push(b+":"+c)});f=h.join(";")}f&&(e[d]=f)}a.attrs=e}if(a.children)for(c=0;e=a.children[c];)ha(e,b),e.parentNode&&c++}else if(t.$cdata[a.tagName])a.parentNode.removeChild(a);else{d=a.parentNode;e=a.getIndex();a.parentNode.removeChild(a,!0);for(c=e;e=d.children[c];)ha(e,b),e.parentNode&&c++}break;case "comment":a.parentNode.removeChild(a)}};UE.filterNode=function(a,b){if(n.isEmptyObject(b))return a;var c;(c=b["-"])&&n.each(c.split(" "),function(a){b[a]="-"});c=
0;for(var d;d=a.children[c];)ha(d,b),d.parentNode&&c++;return a};UE.plugins.defaultfilter=function(){var a=this;a.addInputRule(function(b){var c;b.traversal(function(b){if("element"==b.type){if(!t.$cdata[b.tagName]&&a.options.autoClearEmptyNode&&t.$inline[b.tagName]&&!t.$empty[b.tagName]&&(!b.attrs||n.isEmptyObject(b.attrs))){b.firstChild()?"span"==b.tagName&&(!b.attrs||n.isEmptyObject(b.attrs))&&b.parentNode.removeChild(b,!0):b.parentNode.removeChild(b);return}switch(b.tagName){case "style":case "script":b.setAttr({cdata_tag:b.tagName,
cdata_data:encodeURIComponent(b.innerText()||"")});b.tagName="div";b.removeChild(b.firstChild());break;case "a":(c=b.getAttr("href"))&&b.setAttr("_href",c);break;case "img":if((c=b.getAttr("src"))&&/^data:/.test(c)){b.parentNode.removeChild(b);break}b.setAttr("_src",b.getAttr("src"));break;case "span":if(p.webkit&&(c=b.getStyle("white-space"))&&/nowrap|normal/.test(c))b.setStyle("white-space",""),a.options.autoClearEmptyNode&&n.isEmptyObject(b.attrs)&&b.parentNode.removeChild(b,!0);break;case "p":if(c=
b.getAttr("align"))b.setAttr("align"),b.setStyle("text-align",c);var e=b.getAttr("style");e&&(e=e.replace(/(margin|padding)[^;]+/g,""),b.setAttr("style",e));b.firstChild()||b.innerHTML(UE.browser.ie?"&nbsp;":"<br>");break;case "dl":b.tagName="ul";break;case "dt":case "dd":b.tagName="li";break;case "li":e=b.getAttr("class");(!e||!/list\-/.test(e))&&b.setAttr();e=b.getNodesByTagName("ol ul");UE.utils.each(e,function(a){b.parentNode.insertAfter(a,b)});break;case "td":case "th":case "caption":if(!b.children||
!b.children.length)b.appendChild(p.ie?UE.uNode.createText(" "):UE.uNode.createElement("br"))}}"comment"==b.type&&b.parentNode.removeChild(b)})});a.addOutputRule(function(b){var c;b.traversal(function(b){if("element"==b.type)if(a.options.autoClearEmptyNode&&t.$inline[b.tagName]&&!t.$empty[b.tagName]&&(!b.attrs||n.isEmptyObject(b.attrs)))b.firstChild()?"span"==b.tagName&&(!b.attrs||n.isEmptyObject(b.attrs))&&b.parentNode.removeChild(b,!0):b.parentNode.removeChild(b);else switch(b.tagName){case "div":if(c=
b.getAttr("cdata_tag"))b.tagName=c,b.appendChild(UE.uNode.createText(b.getAttr("cdata_data"))),b.setAttr({cdata_tag:"",cdata_data:""});break;case "a":(c=b.getAttr("_href"))&&b.setAttr({href:c,_href:""});break;case "img":(c=b.getAttr("_src"))&&b.setAttr({src:b.getAttr("_src"),_src:""})}})})};UE.commands.inserthtml={execCommand:function(a,b,c){var d=this,e;if(b&&!0!==d.fireEvent("beforeinserthtml",b)){e=d.selection.getRange();a=e.document.createElement("div");a.style.display="inline";c||(b=UE.htmlparser(b),
d.options.filterRules&&UE.filterNode(b,d.options.filterRules),d.filterInputRule(b),b=b.toHtml());a.innerHTML=n.trim(b);if(!e.collapsed){b=e.startContainer;f.isFillChar(b)&&e.setStartBefore(b);b=e.endContainer;f.isFillChar(b)&&e.setEndAfter(b);e.txtToElmBoundary();e.endContainer&&1==e.endContainer.nodeType&&(b=e.endContainer.childNodes[e.endOffset])&&f.isBr(b)&&e.setEndAfter(b);if(0==e.startOffset&&(b=e.startContainer,f.isBoundaryNode(b,"firstChild")&&(b=e.endContainer,e.endOffset==(3==b.nodeType?
b.nodeValue.length:b.childNodes.length)&&f.isBoundaryNode(b,"lastChild"))))d.body.innerHTML="<p>"+(p.ie?"":"<br/>")+"</p>",e.setStart(d.body.firstChild,0).collapse(!0);!e.collapsed&&e.deleteContents();if(1==e.startContainer.nodeType){b=e.startContainer.childNodes[e.startOffset];var g;if(b&&f.isBlockElm(b)&&(g=b.previousSibling)&&f.isBlockElm(g)){for(e.setEnd(g,g.childNodes.length).collapse();b.firstChild;)g.appendChild(b.firstChild);f.remove(b)}}}var h,j;c=0;var l;e.inFillChar()&&(b=e.startContainer,
f.isFillChar(b)?(e.setStartBefore(b).collapse(!0),f.remove(b)):f.isFillChar(b,!0)&&(b.nodeValue=b.nodeValue.replace(fa,""),e.startOffset--,e.collapsed&&e.collapse(!0)));var k=f.findParentByTagName(e.startContainer,"li",!0);if(k){for(var m;b=a.firstChild;){for(;b&&(3==b.nodeType||!f.isBlockElm(b)||"HR"==b.tagName);)m=b.nextSibling,e.insertNode(b).collapse(),h=b,b=m;if(b)if(/^(ol|ul)$/i.test(b.tagName)){for(;b.firstChild;)h=b.firstChild,f.insertAfter(k,b.firstChild),k=k.nextSibling;f.remove(b)}else m=
b.nextSibling,g=d.document.createElement("li"),f.insertAfter(k,g),g.appendChild(b),h=b,b=m,k=g}k=f.findParentByTagName(e.startContainer,"li",!0);f.isEmptyBlock(k)&&f.remove(k);h&&e.setStartAfter(h).collapse(!0).select(!0)}else{for(;b=a.firstChild;){if(c){for(h=d.document.createElement("p");b&&(3==b.nodeType||!t.$block[b.tagName]);)l=b.nextSibling,h.appendChild(b),b=l;h.firstChild&&(b=h)}e.insertNode(b);l=b.nextSibling;if(!c&&b.nodeType==f.NODE_ELEMENT&&f.isBlockElm(b)&&(h=f.findParent(b,function(a){return f.isBlockElm(a)}))&&
"body"!=h.tagName.toLowerCase()&&!(t[h.tagName][b.nodeName]&&b.parentNode===h)){if(t[h.tagName][b.nodeName])for(j=b.parentNode;j!==h;)g=j,j=j.parentNode;else g=h;f.breakParent(b,g||j);g=b.previousSibling;f.trimWhiteTextNode(g);g.childNodes.length||f.remove(g);!p.ie&&((m=b.nextSibling)&&f.isBlockElm(m)&&m.lastChild&&!f.isBr(m.lastChild))&&m.appendChild(d.document.createElement("br"));c=1}m=b.nextSibling;if(!a.firstChild&&m&&f.isBlockElm(m)){e.setStart(m,0).collapse(!0);break}e.setEndAfter(b).collapse()}b=
e.startContainer;l&&f.isBr(l)&&f.remove(l);if(f.isBlockElm(b)&&f.isEmptyNode(b))if(l=b.nextSibling)f.remove(b),1==l.nodeType&&t.$block[l.tagName]&&e.setStart(l,0).collapse(!0).shrinkBoundary();else try{b.innerHTML=p.ie?f.fillChar:"<br/>"}catch(C){e.setStartBefore(b),f.remove(b)}try{e.select(!0)}catch(q){}}setTimeout(function(){e=d.selection.getRange();e.scrollToView(d.autoHeightEnabled,d.autoHeightEnabled?f.getXY(d.iframe).y:0);d.fireEvent("afterinserthtml")},200)}}};UE.plugins.autotypeset=function(){function a(a,
b){if(!a||3==a.nodeType)return 0;if(f.isBr(a))return 1;if(a&&a.parentNode&&j[a.tagName.toLowerCase()])return l&&l.contains(a)||a.getAttribute("pagebreak")?0:b?!f.isEmptyBlock(a):f.isEmptyBlock(a,RegExp("[\\s"+f.fillChar+"]","g"))}function b(a){a.style.cssText||(f.removeAttributes(a,["style"]),"span"==a.tagName.toLowerCase()&&f.hasNoAttributes(a)&&f.remove(a,!0))}function c(c,d){var j;if(d){if(!e.pasteFilter)return;j=this.document.createElement("div");j.innerHTML=d.html}else j=this.document.body;for(var n=
f.getElementsByTagName(j,"*"),E=0,s;s=n[E++];)if(!0!==this.fireEvent("excludeNodeinautotype",s)){e.clearFontSize&&s.style.fontSize&&(f.removeStyle(s,"font-size"),b(s));e.clearFontFamily&&s.style.fontFamily&&(f.removeStyle(s,"font-family"),b(s));if(a(s)){if(e.mergeEmptyline)for(var A=s.nextSibling,p,Q=f.isBr(s);a(A);){p=A;A=p.nextSibling;if(Q&&(!A||A&&!f.isBr(A)))break;f.remove(p)}if(e.removeEmptyline&&f.inDoc(s,j)&&!h[s.parentNode.tagName.toLowerCase()]){if(f.isBr(s)&&(A=s.nextSibling)&&!f.isBr(A))continue;
f.remove(s);continue}}a(s,!0)&&"SPAN"!=s.tagName&&(e.indent&&(s.style.textIndent=e.indentValue),e.textAlign&&(s.style.textAlign=e.textAlign));if(e.removeClass&&s.className&&!g[s.className.toLowerCase()]){if(l&&l.contains(s))continue;f.removeAttributes(s,["class"])}if(e.imageBlockLine&&"img"==s.tagName.toLowerCase()&&!s.getAttribute("emotion"))if(d)switch(Q=s,e.imageBlockLine){case "left":case "right":case "none":for(var A=Q.parentNode,q;t.$inline[A.tagName]||"A"==A.tagName;)A=A.parentNode;p=A;if("P"==
p.tagName&&"center"==f.getStyle(p,"text-align")&&!f.isBody(p)&&1==f.getChildCount(p,function(a){return!f.isBr(a)&&!f.isWhitespace(a)}))if(q=p.previousSibling,A=p.nextSibling,q&&A&&1==q.nodeType&&1==A.nodeType&&q.tagName==A.tagName&&f.isBlockElm(q)){for(q.appendChild(p.firstChild);A.firstChild;)q.appendChild(A.firstChild);f.remove(p);f.remove(A)}else f.setStyle(p,"text-align","");f.setStyle(Q,"float",e.imageBlockLine);break;case "center":if("center"!=this.queryCommandValue("imagefloat")){A=Q.parentNode;
f.setStyle(Q,"float","none");for(p=Q;A&&1==f.getChildCount(A,function(a){return!f.isBr(a)&&!f.isWhitespace(a)})&&(t.$inline[A.tagName]||"A"==A.tagName);)p=A,A=A.parentNode;A=this.document.createElement("p");f.setAttributes(A,{style:"text-align:center"});p.parentNode.insertBefore(A,p);A.appendChild(p);f.setStyle(p,"float","")}}else this.selection.getRange().selectNode(s).select(),this.execCommand("imagefloat",e.imageBlockLine);e.removeEmptyNode&&e.removeTagNames[s.tagName.toLowerCase()]&&(f.hasNoAttributes(s)&&
f.isEmptyBlock(s))&&f.remove(s)}d&&(d.html=j.innerHTML)}this.setOpt({autotypeset:{mergeEmptyline:!0,removeClass:!0,removeEmptyline:!1,textAlign:"left",imageBlockLine:"center",pasteFilter:!1,clearFontSize:!1,clearFontFamily:!1,removeEmptyNode:!1,removeTagNames:n.extend({div:1},t.$removeEmpty),indent:!1,indentValue:"2em"}});var d=this,e=d.options.autotypeset,g={selectTdClass:1,pagebreak:1,anchorclass:1},h={li:1},j={div:1,p:1,blockquote:1,center:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,span:1},l;e&&(e.pasteFilter&&
d.addListener("beforepaste",c),d.commands.autotypeset={execCommand:function(){d.removeListener("beforepaste",c);e.pasteFilter&&d.addListener("beforepaste",c);c.call(d)}})};UE.plugins.background=function(){var a=this;a.addListener("getAllHtml",function(b,c){var d=this.body,e=f.getComputedStyle(d,"background-image"),g="",g=0<e.indexOf(a.options.imagePath)?e.substring(e.indexOf(a.options.imagePath),e.length-1).replace(/"|\(|\)/ig,""):"none"!=e?e.replace(/url\("?|"?\)/ig,""):"",e='<style type="text/css">body{',
d={"background-color":f.getComputedStyle(d,"background-color")||"#ffffff","background-image":g?"url("+g+")":"","background-repeat":f.getComputedStyle(d,"background-repeat")||"","background-position":p.ie?f.getComputedStyle(d,"background-position-x")+" "+f.getComputedStyle(d,"background-position-y"):f.getComputedStyle(d,"background-position"),height:f.getComputedStyle(d,"height")},h;for(h in d)d.hasOwnProperty(h)&&(e+=h+":"+d[h]+";");c.push(e+"}</style> ")})};UE.commands.imagefloat={execCommand:function(a,
b){var c=this.selection.getRange();if(!c.collapsed){var d=c.getClosedNode();if(d&&"IMG"==d.tagName)switch(b){case "left":case "right":case "none":for(var e=d.parentNode,g,h;t.$inline[e.tagName]||"A"==e.tagName;)e=e.parentNode;g=e;if("P"==g.tagName&&"center"==f.getStyle(g,"text-align")){if(!f.isBody(g)&&1==f.getChildCount(g,function(a){return!f.isBr(a)&&!f.isWhitespace(a)}))if(e=g.previousSibling,h=g.nextSibling,e&&h&&1==e.nodeType&&1==h.nodeType&&e.tagName==h.tagName&&f.isBlockElm(e)){for(e.appendChild(g.firstChild);h.firstChild;)e.appendChild(h.firstChild);
f.remove(g);f.remove(h)}else f.setStyle(g,"text-align","");c.selectNode(d).select()}f.setStyle(d,"float","none"==b?"":b);"none"==b&&f.removeAttributes(d,"align");break;case "center":if("center"!=this.queryCommandValue("imagefloat")){e=d.parentNode;f.setStyle(d,"float","");f.removeAttributes(d,"align");for(g=d;e&&1==f.getChildCount(e,function(a){return!f.isBr(a)&&!f.isWhitespace(a)})&&(t.$inline[e.tagName]||"A"==e.tagName);)g=e,e=e.parentNode;c.setStartBefore(g).setCursor(!1);e=this.document.createElement("div");
e.appendChild(g);f.setStyle(g,"float","");this.execCommand("insertHtml",'<p id="_img_parent_tmp" style="text-align:center">'+e.innerHTML+"</p>");g=this.document.getElementById("_img_parent_tmp");g.removeAttribute("id");g=g.firstChild;c.selectNode(g).select();(h=g.parentNode.nextSibling)&&f.isEmptyNode(h)&&f.remove(h)}}}},queryCommandValue:function(){var a=this.selection.getRange(),b;return a.collapsed?"none":(a=a.getClosedNode())&&1==a.nodeType&&"IMG"==a.tagName?(b=a.getAttribute("align")||f.getComputedStyle(a,
"float"),"none"==b&&(b="center"==f.getComputedStyle(a.parentNode,"text-align")?"center":b),{left:1,right:1,center:1}[b]?b:"none"):"none"},queryCommandState:function(){var a=this.selection.getRange();return a.collapsed?-1:(a=a.getClosedNode())&&1==a.nodeType&&"IMG"==a.tagName?0:-1}};UE.commands.insertimage={execCommand:function(a,b){b=n.isArray(b)?b:[b];if(b.length){var c=this.selection.getRange(),d=c.getClosedNode();if(d&&/img/i.test(d.tagName)&&"edui-faked-video"!=d.className&&!d.getAttribute("word_img")){var e=
b.shift(),g=e.floatStyle;delete e.floatStyle;f.setAttributes(d,e);this.execCommand("imagefloat",g);0<b.length&&(c.setStartAfter(d).setCursor(!1,!0),this.execCommand("insertimage",b))}else{c=[];d="";e=b[0];if(1==b.length)d='<img src="'+e.src+'" '+(e._src?' _src="'+e._src+'" ':"")+(e.width?'width="'+e.width+'" ':"")+(e.height?' height="'+e.height+'" ':"")+("left"==e.floatStyle||"right"==e.floatStyle?' style="float:'+e.floatStyle+';"':"")+(e.title&&""!=e.title?' title="'+e.title+'"':"")+(e.border&&"0"!=
e.border?' border="'+e.border+'"':"")+(e.alt&&""!=e.alt?' alt="'+e.alt+'"':"")+(e.hspace&&"0"!=e.hspace?' hspace = "'+e.hspace+'"':"")+(e.vspace&&"0"!=e.vspace?' vspace = "'+e.vspace+'"':"")+"/>","center"==e.floatStyle&&(d='<p style="text-align: center">'+d+"</p>"),c.push(d);else for(g=0;e=b[g++];)d="<p "+("center"==e.floatStyle?'style="text-align: center" ':"")+'><img src="'+e.src+'" '+(e.width?'width="'+e.width+'" ':"")+(e._src?' _src="'+e._src+'" ':"")+(e.height?' height="'+e.height+'" ':"")+' style="'+
(e.floatStyle&&"center"!=e.floatStyle?"float:"+e.floatStyle+";":"")+(e.border||"")+'" '+(e.title?' title="'+e.title+'"':"")+" /></p>",c.push(d);this.execCommand("insertHtml",c.join(""))}}}};UE.plugins.justify=function(){var a=f.isBlockElm,b={left:1,right:1,center:1,justify:1};UE.commands.justify={execCommand:function(b,d){var e=this.selection.getRange(),g;e.collapsed&&(g=this.document.createTextNode("p"),e.insertNode(g));var h=e.createBookmark(),j=function(a){return 1==a.nodeType?"br"!=a.tagName.toLowerCase()&&
!f.isBookmarkNode(a):!f.isWhitespace(a)};e.enlarge(!0);for(var l=e.createBookmark(),k=f.getNextDomNode(l.start,!1,j),m=e.cloneRange(),p;k&&!(f.getPosition(k,l.end)&f.POSITION_FOLLOWING);)if(3==k.nodeType||!a(k)){for(m.setStartBefore(k);k&&k!==l.end&&!a(k);)p=k,k=f.getNextDomNode(k,!1,null,function(b){return!a(b)});m.setEndAfter(p);k=m.getCommonAncestor();if(!f.isBody(k)&&a(k))f.setStyles(k,n.isString(d)?{"text-align":d}:d);else{k=e.document.createElement("p");f.setStyles(k,n.isString(d)?{"text-align":d}:
d);var q=m.extractContents();k.appendChild(q);m.insertNode(k)}k=f.getNextDomNode(k,!1,j)}else k=f.getNextDomNode(k,!0,j);e.moveToBookmark(l).moveToBookmark(h);g&&(e.setStartBefore(g).collapse(!0),f.remove(g));e.select();return!0},queryCommandValue:function(){var a=this.selection.getStart(),a=f.getComputedStyle(a,"text-align");return b[a]?a:"left"},queryCommandState:function(){var a=this.selection.getStart();return a&&f.findParentByTagName(a,["td","th","caption"],!0)?-1:0}}};UE.plugins.font=function(){function a(a){var b=
a.collapsed,c=a.createBookmark();if(b)for(b=c.start.parentNode;t.$inline[b.tagName];)b=b.parentNode;else b=f.getCommonAncestor(c.start,c.end);n.each(f.getElementsByTagName(b,"span"),function(a){if(a.parentNode&&!f.isBookmarkNode(a))if(/^\s*border\s*:\s*none;\s*/i.test(a.style.cssText))f.remove(a,!0);else{/border/i.test(a.style.cssText)&&("SPAN"==a.parentNode.tagName&&/border/i.test(a.parentNode.style.cssText))&&(a.style.cssText=a.style.cssText.replace(/border[^:]*:[^;]+;?/gi,""));for(var b=a.nextSibling;b&&
...
"none":"underline"==h?"underline":"fontborder"==h?"1px solid #000":"line-through");var l=this,k=this.selection.getRange(),m;if("default"==j)k.collapsed&&(m=l.document.createTextNode("font"),k.insertNode(m).select()),l.execCommand("removeFormat","span,a",d),m&&(k.setStartBefore(m).setCursor(),f.remove(m));else if(k.collapsed){var n=f.findParentByTagName(k.startContainer,"span",!0);m=l.document.createTextNode("font");if(n&&!n.children.length&&!n[p.ie?"innerText":"textContent"].replace(fa,"").length)k.insertNode(m),
c[b]&&(k.selectNode(m).select(),l.execCommand("removeFormat","span,a",d,null),n=f.findParentByTagName(m,"span",!0),k.setStartBefore(m)),n&&(n.style.cssText+=";"+d+":"+j),k.collapse(!0).select();else{k.insertNode(m);k.selectNode(m).select();n=k.document.createElement("span");if(c[b]){if(f.findParentByTagName(m,"a",!0)){k.setStartBefore(m).setCursor();f.remove(m);return}l.execCommand("removeFormat","span,a",d)}n.style.cssText=d+":"+j;m.parentNode.insertBefore(n,m);if(!p.ie||p.ie&&9==p.version)for(var q=
n.parentNode;!f.isBlockElm(q);)"SPAN"==q.tagName&&(n.style.cssText=q.style.cssText+";"+n.style.cssText),q=q.parentNode;Cc?setTimeout(function(){k.setStart(n,0).collapse(!0);a(k,l);k.select()}):(k.setStart(n,0).collapse(!0),a(k,l),k.select())}f.remove(m)}else c[b]&&l.queryCommandValue(b)&&l.execCommand("removeFormat","span,a",d),k=l.selection.getRange(),k.applyInlineStyle("span",{style:d+":"+j}),a(k,l),k.select();return!0},queryCommandValue:function(a){var b=this.selection.getStart();if("underline"==
...
this.queryCommandValue("link")?0:-1}};UE.commands.link={execCommand:function(b,c){var d;c._href&&(c._href=n.unhtml(c._href,/[<">]/g));c.href&&(c.href=n.unhtml(c.href,/[<">]/g));c.textValue&&(c.textValue=n.unhtml(c.textValue,/[<">]/g));var e=d=this.selection.getRange(),g=e.cloneRange(),h=this.queryCommandValue("link");a(e=e.adjustmentBoundary());var j=e.startContainer;if(1==j.nodeType&&h&&(j=j.childNodes[e.startOffset])&&1==j.nodeType&&"A"==j.tagName&&/^(?:https?|ftp|file)\s*:\s*\/\//.test(j[p.ie?
"innerText":"textContent"]))j[p.ie?"innerText":"textContent"]=n.html(c.textValue||c.href);if(!g.collapsed||h)e.removeInlineStyle("a"),g=e.cloneRange();if(g.collapsed){var h=e.document.createElement("a"),l="";c.textValue?(l=n.html(c.textValue),delete c.textValue):l=n.html(c.href);f.setAttributes(h,c);(j=f.findParentByTagName(g.startContainer,"a",!0))&&f.isInNodeEndBoundary(g,j)&&e.setStartAfter(j).collapse(!0);h[p.ie?"innerText":"textContent"]=l;e.insertNode(h).selectNode(h)}else e.applyInlineStyle("a",
...
e),g&&("customstyle"==g&&e.style)&&(k.style.cssText=e.style));k.appendChild(q.extractContents());f.isEmptyNode(k)&&f.fillChar(c.document,k);q.insertNode(k);var E=k.parentNode;a(E)&&(!f.isBody(k.parentNode)&&-1==n.indexOf(b,E.tagName))&&(g&&"customstyle"==g||(E.getAttribute("dir")&&k.setAttribute("dir",E.getAttribute("dir")),E.style.cssText&&(k.style.cssText=E.style.cssText+";"+k.style.cssText),E.style.textAlign&&!k.style.textAlign&&(k.style.textAlign=E.style.textAlign),E.style.textIndent&&!k.style.textIndent&&
(k.style.textIndent=E.style.textIndent),E.style.padding&&!k.style.padding&&(k.style.padding=E.style.padding)),e&&/h\d/i.test(E.tagName)&&!/h\d/i.test(k.tagName)?(f.setAttributes(E,e),g&&("customstyle"==g&&e.style)&&(E.style.cssText=e.style),f.remove(k,!0),k=E):f.remove(k.parentNode,!0));k=-1!=n.indexOf(b,E.tagName)?E:k;k=f.getNextDomNode(k,!1,l)}else k=f.getNextDomNode(k,!0,l);c=c.moveToBookmark(m).moveToBookmark(j);h&&(c.setStartBefore(h).collapse(!0),pN=h.parentNode,f.remove(h),f.isBlockElm(pN)&&
f.isEmptyNode(pN)&&f.fillNode(this.document,pN));p.gecko&&c.collapsed&&1==c.startContainer.nodeType&&(e=c.startContainer.childNodes[c.startOffset])&&(1==e.nodeType&&e.tagName.toLowerCase()==d)&&c.setStart(e,0).collapse(!0);c.select();return!0},queryCommandValue:function(){var a=f.filterNodeList(this.selection.getStartElementPath(),"p h1 h2 h3 h4 h5 h6");return a?a.tagName.toLowerCase():""}}};var va=f.isBlockElm,Jb=function(a){return f.filterNodeList(a.selection.getStartElementPath(),function(a){return a.getAttribute("dir")})};
UE.commands.directionality={execCommand:function(a,b){var c=this.selection.getRange();if(c.collapsed){var d=this.document.createTextNode("d");c.insertNode(d)}var e,g=function(a){return 1==a.nodeType?!f.isBookmarkNode(a):!f.isWhitespace(a)};if((e=Jb(this))&&c.collapsed)e.setAttribute("dir",b);else{e=c.createBookmark();c.enlarge(!0);for(var h=c.createBookmark(),j=f.getNextDomNode(h.start,!1,g),l=c.cloneRange(),k;j&&!(f.getPosition(j,h.end)&f.POSITION_FOLLOWING);)if(3==j.nodeType||!va(j)){for(l.setStartBefore(j);j&&
j!==h.end&&!va(j);)k=j,j=f.getNextDomNode(j,!1,null,function(a){return!va(a)});l.setEndAfter(k);j=l.getCommonAncestor();if(!f.isBody(j)&&va(j))j.setAttribute("dir",b);else{j=c.document.createElement("p");j.setAttribute("dir",b);var m=l.extractContents();j.appendChild(m);l.insertNode(j)}j=f.getNextDomNode(j,!1,g)}else j=f.getNextDomNode(j,!0,g);c.moveToBookmark(h).moveToBookmark(e)}d&&(c.setStartBefore(d).collapse(!0),f.remove(d));c.select();return!0},queryCommandValue:function(){var a=Jb(this);return a?
...
var g="";if(p.ie&&8<p.version){n.each(UE.filterNode(UE.htmlparser(c),d.options.filterTxtRules).children,function(a){"element"==a.type?"br"==a.tagName?g+="\n":t.$empty[a.tagName]||(n.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="\n":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/\n$/.test(g)||(g+="\n")):g+=a.data+"\n";!a.nextSibling()&&/\n$/.test(g)&&(g=g.replace(/\n$/,""))});var h=d.document.createTextNode(n.html(g.replace(/&nbsp;/g," ")));e.insertNode(h).selectNode(h).select()}else{var j=
d.document.createDocumentFragment();n.each(UE.filterNode(UE.htmlparser(c),d.options.filterTxtRules).children,function(a){"element"==a.type?"br"==a.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||(n.each(a.children,function(b){"element"==b.type?"br"==b.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||j.appendChild(d.document.createTextNode(n.html(b.innerText().replace(/&nbsp;/g," ")))):j.appendChild(d.document.createTextNode(n.html(b.data.replace(/&nbsp;/g,
" "))))}),"BR"!=j.lastChild.nodeName&&j.appendChild(d.document.createElement("br"))):j.appendChild(d.document.createTextNode(n.html(a.data.replace(/&nbsp;/g," "))));!a.nextSibling()&&"BR"==j.lastChild.nodeName&&j.removeChild(j.lastChild)});e.insertNode(j).select()}return!0}});a.addListener("keydown",function(a,c){if(40==(c.keyCode||c.which)){var d=this.selection.getRange(),e,g=d.startContainer;if(d.collapsed&&(e=f.findParentByTagName(d.startContainer,"pre",!0))&&!e.nextSibling){for(var h=e.lastChild;h&&
...
function(){var a=this;a.ready(function(){n.cssRule("anchor",".anchorclass{background: url('"+a.options.UEDITOR_HOME_URL+"themes/default/images/anchor.gif') no-repeat scroll left center transparent;border: 1px dotted #0000FF;cursor: auto;display: inline-block;height: 16px;width: 15px;}",a.document)});a.addOutputRule(function(a){n.each(a.getNodesByTagName("img"),function(a){var b;if(b=a.getAttr("anchorname"))a.tagName="a",a.setAttr({anchorname:"",name:b,"class":""})})});a.addInputRule(function(a){n.each(a.getNodesByTagName("a"),
...
d.undoManger.save(!0);clearTimeout(c);var f=function(a){a.selection.getRange().collapsed&&a.fireEvent("contentchange");a.undoManger.save(!1,!0);a.fireEvent("selectionchange")};c=setTimeout(function(){if(m)var a=setInterval(function(){m||(f(d),clearInterval(a))},300);else f(d)},200);k++;k>=e&&f(d)}else d.undoManger.save(!1,!0),q=!1});this.addListener("keyup",function(a,b){if(!l[b.keyCode||b.which]&&(!b.ctrlKey&&!b.metaKey&&!b.shiftKey&&!b.altKey)&&!m&&!q)this.undoManger.save(!1,!0),q=!0})};UE.plugins.list=
function(){function a(a){var b=[],c;for(c in a)b.push(c);return b}function b(a){var b=a.className;return f.hasClass(a,/custom_/)?b.match(/custom_(\w+)/)[1]:f.getStyle(a,"list-style-type")}function c(a,c){n.each(f.getElementsByTagName(a,"ol ul"),function(g){if(f.inDoc(g,a)){var h=g.parentNode;if(h.tagName==g.tagName){var j=b(g)||("OL"==g.tagName?"decimal":"disc"),l=b(h)||("OL"==h.tagName?"decimal":"disc");j==l&&(j=n.indexOf(m[g.tagName],j),j=j+1==m[g.tagName].length?0:j+1,e(g,m[g.tagName][j]))}var r=
0,j=2;if(f.hasClass(g,/custom_/)){if(!/[ou]l/i.test(h.tagName)||!f.hasClass(h,/custom_/))j=1}else/[ou]l/i.test(h.tagName)&&f.hasClass(h,/custom_/)&&(j=3);(h=f.getStyle(g,"list-style-type"))&&(g.style.cssText="list-style-type:"+h);g.className=n.trim(g.className.replace(/list-paddingleft-\w+/,""))+" list-paddingleft-"+j;n.each(f.getElementsByTagName(g,"li"),function(a){a.style.cssText&&(a.style.cssText="");if(a.firstChild){if(a.parentNode===g){r++;if(f.hasClass(g,/custom_/)){var c=1,d=b(g);if("OL"==
...
l=d(h.startContainer,function(a){return"TABLE"==a.tagName});k=h.collapsed?l:d(h.endContainer,function(a){return"TABLE"==a.tagName});if(l&&k&&l===k){if(!h.collapsed)if(l=f.findParentByTagName(h.startContainer,"li",!0),k=f.findParentByTagName(h.endContainer,"li",!0),l&&k&&l===k){if(h.deleteContents(),(k=f.findParentByTagName(h.startContainer,"li",!0))&&f.isEmptyBlock(k)){p=k.previousSibling;next=k.nextSibling;l=j.document.createElement("p");f.fillNode(j.document,l);n=k.parentNode;p&&next?(h.setStart(next,
0).collapse(!0).select(!0),f.remove(k)):(!p&&!next||!p?n.parentNode.insertBefore(l,n):k.parentNode.parentNode.insertBefore(l,n.nextSibling),f.remove(k),n.firstChild||f.remove(n),h.setStart(l,0).setCursor());c();return}}else{var l=h.cloneRange(),m=l.collapse(!1).createBookmark();h.deleteContents();l.moveToBookmark(m);k=f.findParentByTagName(l.startContainer,"li",!0);g(k);l.select();c();return}if(k=f.findParentByTagName(h.startContainer,"li",!0)){if(f.isEmptyBlock(k)){var m=h.createBookmark(),n=k.parentNode;
k!==n.lastChild?(f.breakParent(k,n),g(k)):(n.parentNode.insertBefore(k,n.nextSibling),f.isEmptyNode(n)&&f.remove(n));if(!t.$list[k.parentNode.tagName])if(f.isBlockElm(k.firstChild))f.remove(k,!0);else{l=j.document.createElement("p");for(k.parentNode.insertBefore(l,k);k.firstChild;)l.appendChild(k.firstChild);f.remove(k)}h.moveToBookmark(m).select()}else{l=k.firstChild;if(!l||!f.isBlockElm(l)){l=j.document.createElement("p");for(!k.firstChild&&f.fillNode(j.document,l);k.firstChild;)l.appendChild(k.firstChild);
k.appendChild(l)}m=j.document.createElement("span");h.insertNode(m);f.breakParent(m,k);p=m.nextSibling;l=p.firstChild;l||(l=j.document.createElement("p"),f.fillNode(j.document,l),p.appendChild(l));f.isEmptyNode(l)&&(l.innerHTML="",f.fillNode(j.document,l));h.setStart(l,0).collapse(!0).shrinkBoundary().select();f.remove(m);var p=p.previousSibling;p&&f.isEmptyBlock(p)&&(p.innerHTML="<p></p>",f.fillNode(j.document,p.firstChild))}c()}}}if(8==e&&(h=j.selection.getRange(),h.collapsed&&f.isStartInblock(h)&&
(l=h.cloneRange().trimBoundary(),(k=f.findParentByTagName(h.startContainer,"li",!0))&&f.isStartInblock(l))))if((l=f.findParentByTagName(h.startContainer,"p",!0))&&l!==k.firstChild)n=f.findParentByTagName(l,["ol","ul"]),f.breakParent(l,n),g(l),j.fireEvent("contentchange"),h.setStart(l,0).setCursor(!1,!0),j.fireEvent("saveScene"),f.preventDefault(b);else if(k&&(p=k.previousSibling)){if(!(46==e&&k.childNodes.length)){t.$list[p.tagName]&&(p=p.lastChild);j.undoManger&&j.undoManger.save();l=k.firstChild;
if(f.isBlockElm(l))if(f.isEmptyNode(l)){p.appendChild(l);for(h.setStart(l,0).setCursor(!1,!0);k.firstChild;)p.appendChild(k.firstChild)}else m=j.document.createElement("span"),h.insertNode(m),f.isEmptyBlock(p)&&(p.innerHTML=""),f.moveChild(k,p),h.setStartBefore(m).collapse(!0).select(!0),f.remove(m);else if(f.isEmptyNode(k))l=j.document.createElement("p"),p.appendChild(l),h.setStart(l,0).setCursor();else for(h.setEnd(p,p.childNodes.length).collapse().select(!0);k.firstChild;)p.appendChild(k.firstChild);
f.remove(k);j.fireEvent("contentchange");j.fireEvent("saveScene");f.preventDefault(b)}}else if(k&&!k.previousSibling){n=k.parentNode;m=h.createBookmark();if(f.isTagNode(n.parentNode,"ol ul"))n.parentNode.insertBefore(k,n);else{for(;k.firstChild;)n.parentNode.insertBefore(k.firstChild,n);f.remove(k)}f.isEmptyNode(n)&&f.remove(n);h.moveToBookmark(m).setCursor(!1,!0);j.fireEvent("contentchange");j.fireEvent("saveScene");f.preventDefault(b)}});j.addListener("keyup",function(a,c){if(8==(c.keyCode||c.which)){var e=
...
k=j.document.createElement(l.tagName),p=n.indexOf(m[k.tagName],b(l)||f.getComputedStyle(l,"list-style-type")),p=p+1==m[k.tagName].length?0:p+1,p=m[k.tagName][p];e(k,p);if(f.isStartInblock(c))return j.fireEvent("saveScene"),h=c.createBookmark(),l.insertBefore(k,g),k.appendChild(g),d(k,k.tagName.toLowerCase(),p),j.fireEvent("contentchange"),c.moveToBookmark(h).select(!0),!0}else{j.fireEvent("saveScene");h=c.createBookmark();for(var l=0,q,k=f.findParents(g),C;C=k[l++];)if(f.isTagNode(C,"ol ul")){q=C;
break}C=g;if(h.end)for(;C&&!(f.getPosition(C,h.end)&f.POSITION_FOLLOWING);)if(a(C))C=f.getNextDomNode(C,!1,null,function(a){return a!==q});else{l=C.parentNode;k=j.document.createElement(l.tagName);p=n.indexOf(m[k.tagName],b(l)||f.getComputedStyle(l,"list-style-type"));p=m[k.tagName][p+1==m[k.tagName].length?0:p+1];e(k,p);for(l.insertBefore(k,C);C&&!(f.getPosition(C,h.end)&f.POSITION_FOLLOWING);){g=C.nextSibling;k.appendChild(C);if(!g||f.isTagNode(g,"ol ul")){if(g)for(;(g=g.firstChild)&&"LI"!=g.tagName;);
else g=f.getNextDomNode(C,!1,null,function(a){return a!==q});break}C=g}d(k,k.tagName.toLowerCase(),p);C=g}j.fireEvent("contentchange");c.moveToBookmark(h).select();return!0}}});j.commands.insertorderedlist=j.commands.insertunorderedlist={execCommand:function(a,c){c||(c="insertorderedlist"==a.toLowerCase()?"decimal":"disc");var g=this.selection.getRange(),j=function(a){return 1==a.nodeType?"br"!=a.tagName.toLowerCase():!f.isWhitespace(a)},k="insertorderedlist"==a.toLowerCase()?"ol":"ul",m=this.document.createDocumentFragment();
g.adjustmentBoundary().shrinkBoundary();var p=g.createBookmark(!0),q=h(this.document.getElementById(p.start)),C=0,v=h(this.document.getElementById(p.end)),y=0,z,x,w,u;if(q||v){q&&(z=q.parentNode);p.end||(v=q);v&&(x=v.parentNode);if(z===x){for(;q!==v;){u=q;q=q.nextSibling;if(!f.isBlockElm(u.firstChild)){for(j=this.document.createElement("p");u.firstChild;)j.appendChild(u.firstChild);u.appendChild(j)}m.appendChild(u)}u=this.document.createElement("span");z.insertBefore(u,v);if(!f.isBlockElm(v.firstChild)){for(j=
this.document.createElement("p");v.firstChild;)j.appendChild(v.firstChild);v.appendChild(j)}m.appendChild(v);f.breakParent(u,z);f.isEmptyNode(u.previousSibling)&&f.remove(u.previousSibling);f.isEmptyNode(u.nextSibling)&&f.remove(u.nextSibling);j=b(z)||f.getComputedStyle(z,"list-style-type")||("insertorderedlist"==a.toLowerCase()?"decimal":"disc");if(z.tagName.toLowerCase()==k&&j==c){for(var j=0,F=this.document.createDocumentFragment();v=m.childNodes[j++];)if(f.isTagNode(v,"ol ul"))n.each(f.getElementsByTagName(v,
"li"),function(a){for(;a.firstChild;)F.appendChild(a.firstChild)});else for(;v.firstChild;)F.appendChild(v.firstChild);u.parentNode.insertBefore(F,u)}else w=this.document.createElement(k),e(w,c),w.appendChild(m),u.parentNode.insertBefore(w,u);f.remove(u);w&&d(w,k,c);g.moveToBookmark(p).select();return}if(q){for(;q;){u=q.nextSibling;if(f.isTagNode(q,"ol ul"))m.appendChild(q);else{w=this.document.createDocumentFragment();for(var B=0;q.firstChild;)f.isBlockElm(q.firstChild)&&(B=1),w.appendChild(q.firstChild);
...
B.appendChild(w),m.appendChild(B));f.remove(q)}q=u}u=f.createElement(this.document,"div",{tmpDiv:1});f.moveChild(v,u);m.appendChild(u);f.remove(v);x.parentNode.insertBefore(m,x);g.setEndBefore(x);f.isEmptyNode(x)&&f.remove(x);y=1}}C||g.setStartBefore(this.document.getElementById(p.start));p.end&&!y&&g.setEndAfter(this.document.getElementById(p.end));g.enlarge(!0,function(a){return l[a.tagName]});m=this.document.createDocumentFragment();v=g.createBookmark();z=f.getNextDomNode(v.start,!1,j);q=g.cloneRange();
...
b.ownerDocument.createElement("textarea");c.style.cssText="position:absolute;resize:none;width:100%;height:100%;border:0;padding:0;margin:0;overflow-y:auto;";p.ie&&8>p.version&&(c.style.width=b.offsetWidth+"px",c.style.height=b.offsetHeight+"px",b.onresize=function(){c.style.width=b.offsetWidth+"px";c.style.height=b.offsetHeight+"px"});b.appendChild(c);return{setContent:function(a){c.value=a},getContent:function(){return c.value},select:function(){var a;p.ie?(a=c.createTextRange(),a.collapse(!0),
...
setContent:function(a){c.setValue(a)},getContent:function(){return c.getValue()},select:function(){c.focus()},dispose:function(){b.removeChild(d);c=d=null}}}};UE.plugins.source=function(){var a=this,b=this.options,c=!1,d;b.sourceEditor=p.ie?"textarea":b.sourceEditor||"codemirror";a.setOpt({sourceEditorFirst:!1});var e,g=a.getContent,h;a.commands.source={execCommand:function(){if(c=!c){h=a.selection.getRange().createAddress(!1,!0);a.undoManger&&a.undoManger.save(!0);p.gecko&&(a.body.contentEditable=
...
d=Pc["codemirror"==b.sourceEditor&&window.CodeMirror?"codemirror":"textarea"](a,a.iframe.parentNode);d.setContent(j);setTimeout(function(){d.select();a.addListener("fullscreenchanged",function(){try{d.getCodeMirror().refresh()}catch(a){}})});a.getContent=function(){return d.getContent()||"<p>"+(p.ie?"":"<br/>")+"</p>"}}else if(a.iframe.style.cssText=e,j=d.getContent()||"<p>"+(p.ie?"":"<br/>")+"</p>",a.setContent(j),d.dispose(),d=null,a.getContent=g,j=a.body.firstChild,j||(a.body.innerHTML="<p>"+(p.ie?
"":"<br/>")+"</p>",j=a.body.firstChild),a.undoManger&&a.undoManger.save(!0),p.gecko){var k=document.createElement("input");k.style.cssText="position:absolute;left:0;top:-32768px";document.body.appendChild(k);a.body.contentEditable=!1;setTimeout(function(){f.setViewportOffset(k,{left:-32768,top:0});k.focus();setTimeout(function(){a.body.contentEditable=!0;a.selection.getRange().moveToAddress(h).select(!0);f.remove(k)})})}else try{a.selection.getRange().moveToAddress(h).select(!0)}catch(m){}this.fireEvent("sourcemodechanged",
c)},queryCommandState:function(){return c|0},notNeedUndo:1};var j=a.queryCommandState;a.queryCommandState=function(a){a=a.toLowerCase();return c?a in{source:1,fullscreen:1}?1:-1:j.apply(this,arguments)};"codemirror"==b.sourceEditor&&a.addListener("ready",function(){n.loadFile(document,{src:b.codeMirrorJsUrl||b.UEDITOR_HOME_URL+"third-party/codemirror/codemirror.js",tag:"script",type:"text/javascript",defer:"defer"},function(){b.sourceEditorFirst&&setTimeout(function(){a.execCommand("source")},0)});
n.loadFile(document,{tag:"link",rel:"stylesheet",type:"text/css",href:b.codeMirrorCssUrl||b.UEDITOR_HOME_URL+"third-party/codemirror/codemirror.css"})})};UE.plugins.enterkey=function(){var a,b=this,c=b.options.enterTag;b.addListener("keyup",function(c,e){if(13==(e.keyCode||e.which)){var g=b.selection.getRange(),h=g.startContainer,j;if(p.ie)b.fireEvent("saveScene",!0,!0);else{if(/h\d/i.test(a)){if(p.gecko)f.findParentByTagName(h,"h1 h2 h3 h4 h5 h6 blockquote caption table".split(" "),!0)||(b.document.execCommand("formatBlock",
!1,"<p>"),j=1);else if(1==h.nodeType){var h=b.document.createTextNode(""),l;g.insertNode(h);if(l=f.findParentByTagName(h,"div",!0)){for(j=b.document.createElement("p");l.firstChild;)j.appendChild(l.firstChild);l.parentNode.insertBefore(j,l);f.remove(l);g.setStartBefore(h).setCursor();j=1}f.remove(h)}b.undoManger&&j&&b.undoManger.save()}p.opera&&g.select()}}});b.addListener("keydown",function(d,e){if(13==(e.keyCode||e.which))if(b.fireEvent("beforeenterkeydown"))f.preventDefault(e);else{b.fireEvent("saveScene",
!0,!0);a="";var g=b.selection.getRange();if(!g.collapsed){var h=g.startContainer,j=g.endContainer,h=f.findParentByTagName(h,"td",!0),j=f.findParentByTagName(j,"td",!0);if(h&&j&&h!==j||!h&&j||h&&!j){e.preventDefault?e.preventDefault():e.returnValue=!1;return}}if("p"==c)p.ie||(h=f.findParentByTagName(g.startContainer,"ol ul p h1 h2 h3 h4 h5 h6 blockquote caption".split(" "),!0),!h&&!p.opera?(b.document.execCommand("formatBlock",!1,"<p>"),p.gecko&&(g=b.selection.getRange(),(h=f.findParentByTagName(g.startContainer,
"p",!0))&&f.removeDirtyAttr(h))):(a=h.tagName,"p"==h.tagName.toLowerCase()&&p.gecko&&f.removeDirtyAttr(h)));else if(e.preventDefault?e.preventDefault():e.returnValue=!1,g.collapsed)j=g.document.createElement("br"),g.insertNode(j),j.parentNode.lastChild===j?(j.parentNode.insertBefore(j.cloneNode(!0),j),g.setStartBefore(j)):g.setStartAfter(j),g.setCursor();else if(g.deleteContents(),h=g.startContainer,1==h.nodeType&&(h=h.childNodes[g.startOffset])){for(;1==h.nodeType;){if(t.$empty[h.tagName])return g.setStartBefore(h).setCursor(),
...
"a",!0)){g=a.document.createElement("a");var h=a.document.createTextNode(" "),l;a.undoManger&&a.undoManger.save();g.appendChild(e.extractContents());g.href=g.innerHTML=g.innerHTML.replace(/<[^>]+>/g,"");l=g.getAttribute("href").replace(RegExp(f.fillChar,"g"),"");l=/^(?:https?:\/\/)/ig.test(l)?l:"http://"+l;g.setAttribute("_src",n.html(l));g.href=n.html(l);e.insertNode(g);g.parentNode.insertBefore(h,g.nextSibling);e.setStart(h,0);e.collapse(!0);d.removeAllRanges();d.addRange(e);a.undoManger&&a.undoManger.save()}}}})}};
...
a);b.addListener("keyup",a);b.addListener("mouseup",a);setTimeout(function(){a.call(this)},p.gecko?100:0);b.fireEvent("autoheightchanged",b.autoHeightEnabled)}};b.disableAutoHeight=function(){b.body.style.overflowY=c||"";b.removeListener("contentchange",a);b.removeListener("keyup",a);b.removeListener("mouseup",a);b.autoHeightEnabled=!1;b.fireEvent("autoheightchanged",b.autoHeightEnabled)};b.addListener("ready",function(){b.enableAutoHeight();var c;f.on(p.ie?b.body:b.document,p.webkit?"dragover":"drop",
function(){clearTimeout(c);c=setTimeout(function(){a.call(this)},100)})})}};UE.plugins.autofloat=function(){function a(){t=!0;k.parentNode&&k.parentNode.removeChild(k);m.style.cssText=l}function b(){var b=v(c.container),d=c.options.toolbarTopOffset||0;if(0>b.top&&b.bottom-m.offsetHeight>d){var b=f.getXY(m),d=f.getComputedStyle(m,"position"),g=f.getComputedStyle(m,"left");m.style.width=m.offsetWidth+"px";m.style.zIndex=1*c.options.zIndex+1;m.parentNode.insertBefore(k,m);h||j&&p.ie?("absolute"!=m.style.position&&
(m.style.position="absolute"),m.style.top=(document.body.scrollTop||document.documentElement.scrollTop)-q+e+"px"):(p.ie7Compat&&t&&(t=!1,m.style.left=f.getXY(m).x-document.documentElement.getBoundingClientRect().left+2+"px"),"fixed"!=m.style.position&&(m.style.position="fixed",m.style.top=e+"px",("absolute"==d||"relative"==d)&&parseFloat(g)&&(m.style.left=b.x+"px")))}else a()}var c=this,d=c.getLang();c.setOpt({topOffset:0});var e=c.options.topOffset;if(!1!==c.options.autoFloatEnabled){var g=UE.ui.uiUtils,
h=p.ie&&6>=p.version,j=p.quirks,l,k=document.createElement("div"),m,q,v,t=!0,s=n.defer(function(){b()},p.ie?200:100,!0);c.addListener("destroy",function(){f.un(window,["scroll","resize"],b);c.removeListener("keydown",s)});c.addListener("ready",function(){var e;c.ui?e=1:(alert(d.autofloatMsg),e=0);e&&(v=g.getClientRect,m=c.ui.getDom("toolbarbox"),q=v(m).top,l=m.style.cssText,k.style.height=m.offsetHeight+"px",h&&(e=document.body.style,e.backgroundImage='url("about:blank")',e.backgroundAttachment="fixed"),
...
(j?' style="float:'+j+'"':"")+' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" >'}function b(b,c){n.each(b.getNodesByTagName(c?"img":"embed"),function(b){if("edui-faked-video"==b.getAttr("class")){var d=a(c?b.getAttr("_url"):b.getAttr("src"),b.getAttr("width"),b.getAttr("height"),null,b.getStyle("float")||"",c);b.parentNode.replaceChild(UE.uNode.createElement(d),b)}})}var c=this;c.addOutputRule(function(a){b(a,!0)});c.addInputRule(function(a){b(a)});
c.commands.insertvideo={execCommand:function(b,e){e=n.isArray(e)?e:[e];for(var g=[],h=0,j,l=e.length;h<l;h++)j=e[h],g.push(a(j.url,j.width||420,j.height||280,"tmpVedio"+h,null,!1));c.execCommand("inserthtml",g.join(""),!0);g=this.selection.getRange();h=0;for(l=e.length;h<l;h++)j=this.document.getElementById("tmpVedio"+h),f.removeAttributes(j,"id"),g.selectNode(j).select(),c.execCommand("imagefloat",e[h].align)},queryCommandState:function(){var a=c.selection.getRange().getClosedNode();return a&&"edui-faked-video"==
a.className?1:0}}};var G=UE.UETable=function(a){this.table=a;this.indexTable=[];this.selectedTds=[];this.cellsRange={};this.update(a)};G.removeSelectedClass=function(a){n.each(a,function(a){f.removeClasses(a,"selectTdClass")})};G.addSelectedClass=function(a){n.each(a,function(a){f.addClass(a,"selectTdClass")})};G.isEmptyBlock=function(a){var b=RegExp(f.fillChar,"g");if(0<a[p.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(b,"").length)return 0;for(var c in t.$isNotEmpty)if(t.$isNotEmpty.hasOwnProperty(c)&&
a.getElementsByTagName(c).length)return 0;return 1};G.getWidth=function(a){return!a?0:parseInt(f.getComputedStyle(a,"width"),10)};G.getTableCellAlignState=function(a){!n.isArray(a)&&(a=[a]);var b={},c=["align","valign"],d=null,e=!0;n.each(a,function(a){n.each(c,function(c){d=a.getAttribute(c);if(!b[c]&&d)b[c]=d;else if(!b[c]||d!==b[c])return e=!1});return e});return e?b:null};G.getTableItemsByRange=function(a){var b=a.selection.getStart(),c=(a=b&&f.findParentByTagName(b,["td","th"],!0))&&a.parentNode,
...
a.tagName.toLowerCase();a="td"==b||"th"==b||"caption"==b?f.findParentByTagName(a,"table",!0):a;a.ueTable||(a.ueTable=new G(a));return a.ueTable};G.cloneCell=function(a,b,c){if(!a||n.isString(a))return this.table.ownerDocument.createElement(a||"td");var d=f.hasClass(a,"selectTdClass");d&&f.removeClasses(a,"selectTdClass");var e=a.cloneNode(!0);b&&(e.rowSpan=e.colSpan=1);e.style.borderLeftStyle="";e.style.borderTopStyle="";e.style.borderLeftColor=a.style.borderRightColor;e.style.borderLeftWidth=a.style.borderRightWidth;
...
cellIndex:e,colIndex:j,rowSpan:l,colSpan:h}}}for(k=0;k<b;k++)for(m=0;m<d;m++)void 0===this.indexTable[k][m]&&(g=a[k],h=(h=g.cells[g.cells.length-1])?h.cloneNode(!0):this.table.ownerDocument.createElement("td"),this.setCellContent(h),1!==h.colSpan&&(h.colSpan=1),1!==h.rowSpan&&(h.rowSpan=1),g.appendChild(h),this.indexTable[k][m]={rowIndex:k,cellIndex:h.cellIndex,colIndex:m,rowSpan:1,colSpan:1});a=f.getElementsByTagName(this.table,"td");var p=[];n.each(a,function(a){f.hasClass(a,"selectTdClass")&&p.push(a)});
p.length&&(b=p[p.length-1],a=this.getCellInfo(p[0]),b=this.getCellInfo(b),this.selectedTds=p,this.cellsRange={beginRowIndex:a.rowIndex,beginColIndex:a.colIndex,endRowIndex:b.rowIndex+b.rowSpan-1,endColIndex:b.colIndex+b.colSpan-1})},getCellInfo:function(a){if(a){var b=a.cellIndex;a=a.parentNode.rowIndex;for(var c=this.indexTable[a],d=this.colsNum,e=b;e<d;e++){var f=c[e];if(f.rowIndex===a&&f.cellIndex===b)return f}}},getCell:function(a,b){return a<this.rowsNum&&this.table.rows[a].cells[b]||null},deleteCell:function(a,
b){b="number"==typeof b?b:a.parentNode.rowIndex;this.table.rows[b].deleteCell(a.cellIndex)},getCellsRange:function(a,b){function c(a,b,e,f){var g=a,h=b,j=e,k=f,l,m,p;if(0<a)for(m=b;m<f;m++)l=d.indexTable[a][m],p=l.rowIndex,p<a&&(g=Math.min(p,g));if(f<d.colsNum)for(p=a;p<e;p++)l=d.indexTable[p][f],m=l.colIndex+l.colSpan-1,m>f&&(k=Math.max(m,k));if(e<d.rowsNum)for(m=b;m<f;m++)l=d.indexTable[e][m],p=l.rowIndex+l.rowSpan-1,p>e&&(j=Math.max(p,j));if(0<b)for(p=a;p<e;p++)l=d.indexTable[p][b],m=l.colIndex,
m<b&&(h=Math.min(l.colIndex,h));return g!=a||h!=b||j!=e||k!=f?c(g,h,j,k):{beginRowIndex:a,beginColIndex:b,endRowIndex:e,endColIndex:f}}try{var d=this,e=d.getCellInfo(a);if(a===b)return{beginRowIndex:e.rowIndex,beginColIndex:e.colIndex,endRowIndex:e.rowIndex+e.rowSpan-1,endColIndex:e.colIndex+e.colSpan-1};var f=d.getCellInfo(b),h=Math.min(e.rowIndex,f.rowIndex),j=Math.min(e.colIndex,f.colIndex),l=Math.max(e.rowIndex+e.rowSpan-1,f.rowIndex+f.rowSpan-1),k=Math.max(e.colIndex+e.colSpan-1,f.colIndex+f.colSpan-
...
e.colSpan,c);a.moveToBookmark(b).select()}};UE.commands.deletecol={queryCommandState:function(){if(!w(this).cell)return-1},execCommand:function(){var a=w(this).cell,b=F(a),c=b.cellsRange,d=b.getCellInfo(a),e=b.getHSideCell(a),g=b.getHSideCell(a,!0);if(n.isEmptyObject(c))b.deleteCol(d.colIndex);else for(d=c.beginColIndex;d<c.endColIndex+1;d++)b.deleteCol(c.beginColIndex);b=b.table;c=this.selection.getRange();b.getElementsByTagName("td").length?f.inDoc(a,this.document)?c.setStart(a,0).setCursor(!1,
...
g=a.cellsRange.endRowIndex;h=0;for(b=f.getElementsByTagName(b,"tr");j<=g;j++)c+=b[j].offsetHeight,h+=1;b=h}var l=p.ie&&9>p.version?Math.ceil(c/b):Math.ceil(c/b)-2*d.tdBorder-2*e,a=a.isFullCol()?f.getElementsByTagName(a.table,"td"):a.selectedTds;n.each(a,function(a){1==a.rowSpan&&a.setAttribute("height",l)})}}};UE.commands.cellalignment={queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a,b){var c=O.getUETableBySelected(this);c?n.each(c.selectedTds,function(a){f.setAttributes(a,
b)}):(c=(c=this.selection.getStart())&&f.findParentByTagName(c,["td","th","caption"],!0),/caption/ig.test(c.tagName)?(c.style.textAlign=b.align,c.style.verticalAlign=b.vAlign):f.setAttributes(c,b),this.selection.getRange().setCursor(!0))},queryCommandValue:function(){var a=w(this).cell;a||(a=P(this)[0]);if(a){var b=UE.UETable.getUETable(a).selectedTds;!b.length&&(b=a);return UE.UETable.getTableCellAlignState(b)}return null}};UE.commands.tablealignment={queryCommandState:function(){return p.ie&&8>
p.version?-1:w(this).table?0:-1},execCommand:function(a,b){var c=this.selection.getStart();(c=c&&f.findParentByTagName(c,["table"],!0))&&c.setAttribute("align",b)}};UE.commands.edittable={queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a,b){var c=this.selection.getRange();if(c=f.findParentByTagName(c.startContainer,"table")){var d=f.getElementsByTagName(c,"td").concat(f.getElementsByTagName(c,"th"),f.getElementsByTagName(c,"caption"));c.style.borderCollapse="collapse";
n.each(d,function(a){a.style.borderColor=b;a.style.borderWidth="1px";a.style.borderStyle="solid"})}}};UE.commands.edittd={queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a,b){var c=O.getUETableBySelected(this);if(c)n.each(c.selectedTds,function(a){a.style.backgroundColor=b});else if(c=(c=this.selection.getStart())&&f.findParentByTagName(c,["td","th","caption"],!0))c.style.backgroundColor=b}};UE.commands.sorttable={queryCommandState:function(){var a=w(this);if(!a.cell)return-1;
...
UE.commands.settablebackground={queryCommandState:function(){var a=P(this);return a.length&&"td"===a[0].tagName.toLowerCase()?0:-1},execCommand:function(a,b){var c;c=P(this);F(c[0]).setBackground(c,b)}};UE.commands.cleartablebackground={queryCommandState:function(){var a=P(this);if(!a.length)return-1;for(var b=0,c;c=a[b++];)if(""!==c.style.backgroundColor)return 0;return-1},execCommand:function(){var a=P(this);F(a[0]).removeBackground(a)}};UE.commands.interlacetable=UE.commands.uninterlacetable={queryCommandState:function(a){var b=
w(this).table;if(!b)return-1;b=b.getAttribute("interlaced");return"interlacetable"==a?"enabled"===b?-1:0:!b||"disabled"===b?-1:0},execCommand:function(a,b){var c=w(this).table;"interlacetable"==a?(c.setAttribute("interlaced","enabled"),this.fireEvent("interlacetable",c,b)):(c.setAttribute("interlaced","disabled"),this.fireEvent("uninterlacetable",c))}};UE.plugins.table=function(){function a(a,b,c){a.style[b]&&(c&&a.setAttribute(b,parseInt(a.style[b],10)),a.style[b]="")}function b(a){if("TD"==a.tagName||
"TH"==a.tagName)return a;var b;return(b=f.findParentByTagName(a,"td",!0)||f.findParentByTagName(a,"th",!0))?b:null}function c(a){var b=RegExp(f.fillChar,"g");if(0<a[p.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(b,"").length)return 0;for(var c in t.$isNotEmpty)if(a.getElementsByTagName(c).length)return 0;return 1}function d(a){return a.pageX||a.pageY?{x:a.pageX,y:a.pageY}:{x:a.clientX+r.document.body.scrollLeft-r.document.body.clientLeft,y:a.clientY+r.document.body.scrollTop-r.document.body.clientTop}}
function e(a){try{var c=b(a.target||a.srcElement),e;if(I&&J)if(r.document.body.style.webkitUserSelect="none",r.selection.getNative()[p.ie?"empty":"removeAllRanges"](),e=d(a),j(r,!0,"",e,c),"h"==I){var k=K.style,m;var c=J,n=D(c);if(n){var q=n.getSameEndPosCells(c,"x")[0],s=n.getSameStartPosXCells(c)[0],t=d(a).x,Lb=(q?f.getXY(q).x:f.getXY(n.table).x)+20,u=s?f.getXY(s).x+s.offsetWidth-20:r.body.offsetWidth+5||parseInt(f.getComputedStyle(r.body,"width"),10);m=t<Lb?Lb:t>u?u:t}else m=void 0;k.left=m+"px"}else{if("v"==
I){var Qc=K.style,v;a:{try{var w=f.getXY(J).y,C=d(a).y;v=C<w?w:C;break a}catch(y){if(F)throw y;}v=void 0}Qc.top=v+"px"}}else if(c){if(!0!==r.fireEvent("excludetable",c)){e=d(a);var x=l(c,e),z=f.findParentByTagName(c,"table",!0);h(z,c,a,!0)?!0!==r.fireEvent("excludetable",z)&&(r.body.style.cursor="url("+r.options.cursorpath+"h.png),pointer"):h(z,c,a)?!0!==r.fireEvent("excludetable",z)&&(r.body.style.cursor="url("+r.options.cursorpath+"v.png),pointer"):(r.body.style.cursor="text",/\d/.test(x)&&(x=x.replace(/\d/,
""),c=D(c).getPreviewCell(c,"v"==x)),j(r,c?!!x:!1,c?x:"",e,c))}}else g(!1,z,r)}catch(A){if(F)throw A;}}function g(a,b,c){if(a){a=f.getXY(b);var d=b.ownerDocument;if(!L||!L.parentNode){L=d.createElement("div");L.contentEditable=!1;L.innerHTML="";L.style.cssText="width:15px;height:15px;background-image:url("+c.options.UEDITOR_HOME_URL+"dialogs/table/dragicon.png);position: absolute;cursor:move;top:"+(a.y-15)+"px;left:"+a.x+"px;";f.unSelectable(L);L.onmouseover=function(){N=!0};L.onmouseout=function(){N=
...
d(c);b=l(b,c);return e?(e=(e=a.getElementsByTagName("caption")[0])?e.offsetHeight:0,"v1"==b&&8>c.y-f.getXY(a).y-e):"h1"==b&&8>c.x-f.getXY(a).x}function j(a,b,c,d,e){try{a.body.style.cursor="h"==c?"col-resize":"v"==c?"row-resize":"text",p.ie&&(c&&!P&&!M.getUETableBySelected(a)?(w(a,a.document),y(c,e)):s(a)),O=b}catch(f){if(F)throw f;}}function l(a,b){var c=f.getXY(a);return 4>c.x+a.offsetWidth-b.x?"h":4>b.x-c.x?"h1":4>c.y+a.offsetHeight-b.y?"v":4>b.y-c.y?"v1":""}function k(a,b){if(2==b.button){var c=
M.getUETableBySelected(r),e=!1;if(c){var g=Ib(r,b);n.each(c.selectedTds,function(a){a===g&&(e=!0)});e?(g=c.selectedTds[0],setTimeout(function(){r.selection.getRange().setStart(g,0).setCursor(!1,!0)},0)):(H(f.getElementsByTagName(r.body,"td")),H(f.getElementsByTagName(r.body,"th")),c.clearSelected())}}else if(!b.shiftKey&&(H(f.getElementsByTagName(r.body,"td")),H(f.getElementsByTagName(r.body,"th")),n.each(r.document.getElementsByTagName("table"),function(a){a.ueTable=null}),z=Ib(r,b)))if(c=f.findParentByTagName(z,
"table",!0),(c=D(c))&&c.clearSelected(),O){if(!(p.ie&&8>p.version)){c=l(z,d(b));/\d/.test(c)&&(c=c.replace(/\d/,""),z=D(z).getPreviewCell(z,"v"==c));s(r);for(var h;h=r.document.getElementById("ue_tableDragLine");)f.remove(h);r.fireEvent("saveScene");w(r,r.document);y(c,z);P=!0;I=c;J=z}}else r.document.body.style.webkitUserSelect="",P=!0,r.addListener("mouseover",q)}function m(a,b){if(2!=b.button){var c=this.selection.getRange(),d=f.findParentByTagName(c.startContainer,"table",!0),e=f.findParentByTagName(c.endContainer,
"table",!0);if(d||e)d===e?(d=f.findParentByTagName(c.startContainer,["td","th","caption"],!0),e=f.findParentByTagName(c.endContainer,["td","th","caption"],!0),d!==e&&this.selection.clearRange()):this.selection.clearRange();P=!1;this.document.body.style.webkitUserSelect="";if((!p.ie||p.ie&&7<p.version)&&I&&J){K=this.document.getElementById("ue_tableDragLine");var e=f.getXY(J),g=f.getXY(K);switch(I){case "h":var c=J,h=g.x-e.x-J.offsetWidth;if(!(10>Math.abs(h))){var j=D(c);if(j){var d=j.table,e=u(d),
g=M.getDefaultValue(r,d),k=j.getSameEndPosCells(c,"x"),l=u(k[0])-2*g.tdPadding-g.tdBorder,j=j.getSameStartPosXCells(c),m=u(j[0])-2*g.tdPadding-g.tdBorder;n.each(k,function(a){a.style.width&&(a.style.width="");0>h&&(a.style.wordBreak="break-all");a.setAttribute("width",l+h)});n.each(j,function(a){a.style.width&&(a.style.width="");0<h&&(a.style.wordBreak="break-all");a.setAttribute("width",m-h)});c.nextSibling||(d.style.width&&(d.style.width=""),d.setAttribute("width",e+h))}}break;case "v":if(d=J,c=
g.y-e.y-J.offsetHeight,!(10>Math.abs(c))&&(e=D(d))){d=e.getSameEndPosCells(d,"y");e=d[0]?d[0].offsetHeight:0;for(g=0;k=d[g++];){var s=c,t=e,j=parseInt(f.getComputedStyle(k,"line-height"),10),s=t+s,s=s<j?j:s;k.style.height&&(k.style.height="");1==k.rowSpan?k.setAttribute("height",s):k.removeAttribute&&k.removeAttribute("height")}}}I="";for(J=null;c=this.document.getElementById("ue_tableDragLine");)f.remove(c);this.fireEvent("saveScene");c&&this.document.appendChild(c)}else{if(z)(d=(c=D(z))?c.selectedTds[0]:
null)?(c=new R.Range(this.document),f.isEmptyBlock(d)?c.setStart(d,0).setCursor(!1,!0):c.selectNodeContents(d).shrinkBoundary().setCursor(!1,!0)):(c=this.selection.getRange().shrinkBoundary(),c.collapsed||(d=f.findParentByTagName(c.startContainer,["td","th"],!0),e=f.findParentByTagName(c.endContainer,["td","th"],!0),(d&&!e||!d&&e||d&&e&&d!==e)&&c.setCursor(!1,!0))),z=null,this.removeListener("mouseover",q);else if((d=f.findParentByTagName(b.target||b.srcElement,"td",!0))||(d=f.findParentByTagName(b.target||
b.srcElement,"th",!0)),d&&("TD"==d.tagName||"TH"==d.tagName)){if(!0===this.fireEvent("excludetable",d))return;c=new R.Range(this.document);c.setStart(d,0).setCursor(!1,!0)}this._selectionChange(250,b)}}}function q(a,b){var c=b.target||b.srcElement;G=f.findParentByTagName(c,"td",!0)||f.findParentByTagName(c,"th",!0);if(z&&G&&("TD"==z.tagName&&"TD"==G.tagName||"TH"==z.tagName&&"TH"==G.tagName)&&f.findParentByTagName(z,"table")==f.findParentByTagName(G,"table"))if(c=D(G),z!=G){this.document.body.style.webkitUserSelect=
"none";this.selection.getNative()[p.ie?"empty":"removeAllRanges"]();var d=c.getCellsRange(z,G);c.setSelected(d)}else this.document.body.style.webkitUserSelect="",c.clearSelected();b.preventDefault?b.preventDefault():b.returnValue=!1}function u(a){return!a?0:parseInt(f.getComputedStyle(a,"width"),10)}function w(a){P||(K=a.document.createElement("div"),f.setAttributes(K,{id:"ue_tableDragLine",unselectable:"on",contenteditable:!1,onresizestart:"return false",ondragstart:"return false",onselectstart:"return false",
style:"background-color:blue;position:absolute;padding:0;margin:0;background-image:none;border:0px none;opacity:0;filter:alpha(opacity=0)"}),a.body.appendChild(K))}function s(a){if(!P)for(var b;b=a.document.getElementById("ue_tableDragLine");)f.remove(b)}function y(a,b){if(b){var c=f.findParentByTagName(b,"table"),d=c.getElementsByTagName("caption"),e=c.offsetWidth,g=c.offsetHeight-(0<d.length?d[0].offsetHeight:0),c=f.getXY(c),h=f.getXY(b);switch(a){case "h":d="height:"+g+"px;top:"+(c.y+(0<d.length?
d[0].offsetHeight:0))+"px;left:"+(h.x+b.offsetWidth-2);K.style.cssText=d+"px;position: absolute;display:block;background-color:blue;width:1px;border:0; color:blue;opacity:.3;filter:alpha(opacity=30)";break;case "v":d="width:"+e+"px;left:"+c.x+"px;top:"+(h.y+b.offsetHeight-2),K.style.cssText=d+"px;overflow:hidden;position: absolute;display:block;background-color:blue;height:1px;border:0;color:blue;opacity:.2;filter:alpha(opacity=20)"}}}function x(a,b){for(var c=f.getElementsByTagName(a.body,"table"),
d,e=0,g;g=c[e++];)d=f.getElementsByTagName(g,"td"),d[0]&&(b?(d=d[0].style.borderColor.replace(/\s/g,""),/(#ffffff)|(rgb\(255,f55,255\))/ig.test(d)&&f.addClass(g,"noBorderTable")):f.removeClasses(g,"noBorderTable"))}function B(a,b,c){var d=a.body;return d.offsetWidth-(b?2*parseInt(f.getComputedStyle(d,"margin-left"),10):0)-2*c.tableBorder-(a.options.offsetWidth||0)}function Ib(a,b){var c=f.findParentByTagName(b.target||b.srcElement,["td","th"],!0);return c&&!0!==a.fireEvent("excludetable",c)?c:null}
var r=this,F=!0,M=UE.UETable,D=function(a){return M.getUETable(a)},H=function(a){return M.removeSelectedClass(a)};r.ready(function(){var a=this,b=a.selection.getText;a.selection.getText=function(){var c=M.getUETableBySelected(a);if(c){var d="";n.each(c.selectedTds,function(a){d+=a[p.ie?"innerText":"textContent"]});return d}return b.call(a.selection)}});var z=null,G=null,I="",O=!1,L=null,N=!1,K=null,J=null,P=!1;r.setOpt({maxColNum:20,maxRowNum:100,defaultCols:5,defaultRows:5,tdvalign:"top",cursorpath:r.options.UEDITOR_HOME_URL+
"themes/default/images/cursor_",tableDragable:!1,classList:["ue-table-interlace-color-single","ue-table-interlace-color-double"]});r.getUETable=D;var S={deletetable:1,inserttable:1,cellvalign:1,insertcaption:1,deletecaption:1,inserttitle:1,deletetitle:1,mergeright:1,mergedown:1,mergecells:1,insertrow:1,insertrownext:1,deleterow:1,insertcol:1,insertcolnext:1,deletecol:1,splittocells:1,splittorows:1,splittocols:1,adaptbytext:1,adaptbywindow:1,adaptbycustomer:1,insertparagraph:1,insertparagraphbeforetable:1,
averagedistributecol:1,averagedistributerow:1};r.ready(function(){n.cssRule("table",".selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:2px solid #BBB;background:#F7F7F7;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}",
...
10)-2*g.tableBorder-(e.options.offsetWidth||0);e.execCommand("insertHTML","<table  "+(t&&u?'width="'+g+'"':"")+">"+h.innerHTML.replace(/>\s*</g,"><").replace(/\bth\b/gi,"td")+"</table>")}e.fireEvent("contentchange");e.fireEvent("saveScene");d.html="";return!0}g=e.document.createElement("div");g.innerHTML=d.html;s=g.getElementsByTagName("table");f.findParentByTagName(e.selection.getStart(),"table")?(n.each(s,function(a){f.remove(a)}),f.findParentByTagName(e.selection.getStart(),"caption",!0)&&(g.innerHTML=
g[p.ie?"innerText":"textContent"])):n.each(s,function(b){a(b,"width",!0);a(b,"height",!0);f.removeAttributes(b,["style","border"]);n.each(f.getElementsByTagName(b,"td"),function(b){c(b)&&f.fillNode(e.document,b);a(b,"width",!0);a(b,"height",!0)})});d.html=g.innerHTML}});r.addListener("afterpaste",function(){n.each(f.getElementsByTagName(r.body,"table"),function(a){if(a.offsetWidth>r.body.offsetWidth){var b=M.getDefaultValue(r,a);a.style.width=r.body.offsetWidth-2*parseInt(f.getComputedStyle(r.body,
...
this;s(a);if(!M.getUETableBySelected(a)){var c=a.selection.getRange().startContainer,c=f.findParentByTagName(c,["td","th"],!0);n.each(f.getElementsByTagName(a.document,"table"),function(e){!0!==a.fireEvent("excludetable",e)&&(e.ueTable=new M(e),n.each(f.getElementsByTagName(a.document,"td"),function(b){f.isEmptyBlock(b)&&b!==c&&(f.fillNode(a.document,b),p.ie&&6==p.version&&(b.innerHTML="&nbsp;"))}),n.each(f.getElementsByTagName(a.document,"th"),function(b){f.isEmptyBlock(b)&&b!==c&&(f.fillNode(a.document,
b),p.ie&&6==p.version&&(b.innerHTML="&nbsp;"))}),e.onmouseover=function(){a.fireEvent("tablemouseover",e)},e.onmousemove=function(){a.fireEvent("tablemousemove",e);a.options.tableDragable&&g(!0,this,a)},e.onmouseout=function(){a.fireEvent("tablemouseout",e);j(a,!1,"",null);s(a)},e.onclick=function(c){c=a.window.event||c;var d=b(c.target||c.srcElement);if(d){var e=D(d),f=e.table,g=e.getCellInfo(d),j=a.selection.getRange();h(f,d,c,!0)?(f=e.getCell(e.indexTable[e.rowsNum-1][g.colIndex].rowIndex,e.indexTable[e.rowsNum-
...
"x"),k=c.table;k.removeAttribute("width");n.each(j,function(a){a.removeAttribute("width")});setTimeout(function(){var b=j[0].offsetWidth-20;n.each(j,function(a){a.setAttribute("width",b)});k.setAttribute("width",k.offsetWidth);a.fireEvent("saveScene",!0)})}}})});x(a,!0)}});if(!p.ie||p.ie&&7<p.version)f.on(r.document,"mousemove",e);f.on(r.document,"mouseout",function(a){"TABLE"==(a.target||a.srcElement).tagName&&j(r,!1,"",null)});r.addListener("interlacetable",function(a,b,c){if(b){a=b.rows;b=a.length;
...
r.__hasEnterExecCommand=!1,a=this.selection.getRange(),a.setStart(d.rows[d.rows.length-1].cells[0],0).setCursor(),r.fireEvent("saveScene"))}return!0}});p.ie&&r.addListener("selectionchange",function(){j(this,!1,"",null)});r.addListener("keydown",function(a,b){var c=b.keyCode||b.which;if(!(8==c||46==c)){(c=!b.ctrlKey&&!b.metaKey&&!b.shiftKey&&!b.altKey)&&H(f.getElementsByTagName(this.body,"td"));var d=M.getUETableBySelected(this);d&&c&&d.clearSelected()}});r.addListener("beforegetcontent",function(){x(this,
!1);p.ie&&n.each(this.document.getElementsByTagName("caption"),function(a){f.isEmptyNode(a)&&(a.innerHTML="&nbsp;")})});r.addListener("aftergetcontent",function(){x(this,!0)});r.addListener("getAllHtml",function(){H(r.document.getElementsByTagName("td"))});r.addListener("fullscreenchanged",function(a,b){if(!b){var c=this.body.offsetWidth/document.body.offsetWidth,d=f.getElementsByTagName(this.body,"table");n.each(d,function(a){if(a.offsetWidth<r.body.offsetWidth)return!1;var b=f.getElementsByTagName(a,
"td"),d=[];n.each(b,function(a){d.push(a.offsetWidth)});for(var e=0,g;g=b[e];e++)g.setAttribute("width",Math.floor(d[e]*c));a.setAttribute("width",Math.floor(B(r,!0,M.getDefaultValue(r,void 0))))})}});var C=r.execCommand;r.execCommand=function(a){a=a.toLowerCase();var b=M.getUETableBySelected(this),d=new R.Range(this.document),e=this.commands[a]||UE.commands[a],g;if(e){if(b&&!S[a]&&!e.notNeedUndo&&!this.__hasEnterExecCommand){this.__hasEnterExecCommand=!0;this.fireEvent("beforeexeccommand",a);for(var b=
...
{label:b.paste,cmdName:"paste",exec:function(){alert(b.pastemsg)},query:function(){return 0}},{label:b.highlightcode,cmdName:"highlightcode",exec:function(){UE.ui.highlightcode&&new UE.ui.highlightcode(this);this.ui._dialogs.highlightcodeDialog.open()}}];if(d.length){var e=UE.ui.uiUtils;a.addListener("contextmenu",function(g,h){var j=e.getViewportOffsetByEvent(h);a.fireEvent("beforeselectionchange");c&&c.destroy();for(var l=0,k,m=[];k=d[l];l++){var n;(function(c){if("-"==c)(n=m[m.length-1])&&"-"!==
n&&m.push("-");else if(c.hasOwnProperty("group")){for(var d=0,e,f=[];e=c.subMenu[d];d++)(function(b){if("-"==b)(n=f[f.length-1])&&"-"!==n?f.push("-"):f.splice(f.length-1);else if((a.commands[b.cmdName]||UE.commands[b.cmdName]||b.query)&&-1<(b.query?b.query():a.queryCommandState(b.cmdName)))f.push({label:b.label||a.getLang("contextMenu."+b.cmdName+(b.value||""))||"",className:"edui-for-"+b.cmdName+(b.className?" edui-for-"+b.cmdName+"-"+b.className:""),onclick:b.exec?function(){b.exec.call(a)}:function(){a.execCommand(b.cmdName,
...
editor:a});c.render();c.showAt(j);f.preventDefault(h);if(p.ie){var q;try{q=a.selection.getNative().createRange()}catch(t){return}q.item&&(new R.Range(a.document)).selectNode(q.item(0)).select(!0,!0)}})}};UE.plugins.basestyle=function(){var a={bold:["strong","b"],italic:["em","i"],subscript:["sub"],superscript:["sup"]},b=this;b.addshortcutkey({Bold:"ctrl+66",Italic:"ctrl+73",Underline:"ctrl+85"});b.addInputRule(function(a){n.each(a.getNodesByTagName("b i"),function(a){switch(a.tagName){case "b":a.tagName=
...
a=e.getNative().createRange());h++;if(!d.all)break}else{j=this.window;for(e=e.getNative();;){d.all?(a?(a.collapse(!1),f=a):(f=this.document.createRange(),f.setStart(this.document.body,0),f.collapse(!0)),e.removeAllRanges(),e.addRange(f),b=0,d.dir=1):(p.safari&&this.selection.getRange().select(),e=j.getSelection(),e.rangeCount?f=e.getRangeAt(0):(f=this.document.createRange(),f.setStart(this.body,0),f.collapse(!0),e.addRange(f)),d.hasOwnProperty("replaceStr")&&f.collapse(1==d.dir?!0:!1));b?e.removeAllRanges():
...
/^(https?|ftp):/i.test(l)){a:{k=l;for(var m=c,p=0,n=void 0;n=m[p++];)if(-1!==k.indexOf(n)){k=!0;break a}k=!1}k=!k}k&&g.push(l)}g.length&&(j={success:function(b){try{var c=eval("("+b.responseText+")")}catch(d){return}b=c.srcUrl.split(e);for(var c=c.url.split(e),g=0,j;j=h[g++];)for(var k=j.getAttribute("_src")||j.src||"",l=0,m;m=b[l++];){var p=c[l-1];if(k==m&&"error"!=p){k=a.options.catcherPath+p;f.setAttributes(j,{src:k,_src:k});break}}a.fireEvent("catchremotesuccess")},error:function(){a.fireEvent("catchremoteerror")}},
g=g.join(e),j={timeout:6E4,onsuccess:j.success,onerror:j.error},j[a.options.catchFieldName]=g,b.request(d,j))})}};UE.commands.insertparagraph={execCommand:function(a,b){for(var c=this.selection.getRange(),d=c.startContainer,e;d&&!f.isBody(d);)e=d,d=d.parentNode;e&&(d=this.document.createElement("p"),b?e.parentNode.insertBefore(d,e):e.parentNode.insertBefore(d,e.nextSibling),f.fillNode(this.document,d),c.setStart(d,0).setCursor(!1,!0))}};UE.plugins.webapp=function(){function a(a,b,f){return!b?(f?"<p>":
"")+'<img title="'+a.title+'" width="'+a.width+'" height="'+a.height+'" src="'+c.options.UEDITOR_HOME_URL+'themes/default/images/spacer.gif" style="background:url('+a.logo+') no-repeat center center; border:1px solid gray;" class="edui-faked-webapp" _url="'+a.url+'" />'+(f?"</p>":""):'<iframe class="edui-faked-webapp" title="'+a.title+'" width="'+a.width+'" height="'+a.height+'"  scrolling="no" frameborder="0" src="'+a.url+'" logo_url = '+a.logo+"></iframe>"}function b(b){for(var e,g=f.getElementsByTagName(c.document,
!b?"iframe":"img"),h=0,j;j=g[h++];)"edui-faked-webapp"==j.className&&(e=c.document.createElement("div"),e.innerHTML=a(b?{url:j.getAttribute("_url"),width:j.width,height:j.height,title:j.title,logo:j.style.backgroundImage.replace("url(","").replace(")","")}:{url:j.getAttribute("src",2),title:j.title,width:j.width,height:j.height,logo:j.getAttribute("logo_url")},b?!0:!1,!1),j.parentNode.replaceChild(e.firstChild,j))}var c=this;c.addListener("beforegetcontent",function(){b(!0)});c.addListener("aftersetcontent",
function(){b(!1)});c.addListener("aftergetcontent",function(a){"aftergetcontent"==a&&c.queryCommandState("source")||b(!1)});c.commands.webapp={execCommand:function(b,e){c.execCommand("inserthtml",a(e,!1,!0))}}};UE.plugins.template=function(){UE.commands.template={execCommand:function(a,b){b.html&&this.execCommand("inserthtml",b.html)}};this.addListener("click",function(a,b){var c=b.target||b.srcElement,d=this.selection.getRange();(c=f.findParent(c,function(a){if(a.className&&f.hasClass(a,"ue_t"))return a},
!0))&&d.selectNode(c).shrinkBoundary().select()});this.addListener("keydown",function(a,b){var c=this.selection.getRange();!c.collapsed&&!b.ctrlKey&&!b.metaKey&&!b.shiftKey&&!b.altKey&&(c=f.findParent(c.startContainer,function(a){if(a.className&&f.hasClass(a,"ue_t"))return a},!0))&&f.removeClasses(c,["ue_t"])})};UE.plugins.music=function(){function a(a,b,f,h,j,l){return!j?(l?"<p "+("none"!=h?"center"==h?' style="text-align:center;" ':' style="float:"'+h:"")+">":"")+'<img align="'+h+'" width="'+b+
...
a.safeSetOffset(T.getClientRect(a.getDom()))})});if(this.holdScroll)if(a.iframeUrl)a.addListener("dialogafterreset",function(){window.setTimeout(function(){var b=document.getElementById(a.id+"_iframe").contentWindow;if(p.ie)var d=window.setInterval(function(){b.document&&b.document.body&&(window.clearInterval(d),d=null,S.on(b.document.body,!p.gecko?"mousewheel":"DOMMouseScroll",function(a){S.preventDefault(a)}))},100);else S.on(b,!p.gecko?"mousewheel":"DOMMouseScroll",function(a){S.preventDefault(a)})},
1)});else S.on(document.getElementById(a.id+"_iframe"),!p.gecko?"mousewheel":"DOMMouseScroll",function(a){S.preventDefault(a)});this._hide()},mesureSize:function(){var a=this.getDom("body"),b=T.getClientRect(this.getDom("content")).width;a.style.width=b;return T.getClientRect(a)},_onTitlebarMouseDown:function(a){if(this.draggable){var b;T.getViewportRect();var c=this;T.startDrag(a,{ondragstart:function(){b=T.getClientRect(c.getDom());c.getDom("contmask").style.visibility="visible";c.dragMask.show(c.getDom().style.zIndex-
...
ok:"attachment anchor link insertimage map gmap insertframe wordimage insertvideo insertframe edittip edittable edittd scrawl template music background".split(" ")};for(da in vc)(function(a,b){for(var c=0,d;d=b[c++];)p.opera&&"searchreplace"===d||function(b){y[b]=function(c,d,f){d=d||(c.options.iframeUrlMap||{})[b]||$a[b];f=c.options.labelMap[b]||c.getLang("labelMap."+b)||"";var l;d&&(l=new y.Dialog(za.extend({iframeUrl:c.ui.mapUrl(d),editor:c,className:"edui-for-"+b,title:f,holdScroll:"insertimage"===
...
this;this._dialogs={};this.initUIBase();this._initToolbars();var b=this.editor,c=this;b.addListener("ready",function(){b.getDialog=function(a){return b.ui._dialogs[a+"Dialog"]};H.on(b.window,"scroll",function(a){q.editor.ui.Popup.postHide(a)});b.ui._actualFrameWidth="100%";b.options.elementPathEnabled&&(b.ui.getDom("elementpath").innerHTML='<div class="edui-editor-breadcrumb">'+b.getLang("elementPathTip")+":</div>");b.options.wordCount&&(H.on(b.document,"click",function(){a(b,c);H.un(b.document,"click",
arguments.callee)}),b.ui.getDom("wordcount").innerHTML=b.getLang("wordCountTip"));b.ui._scale();b.options.scaleEnabled?(b.autoHeightEnabled&&b.disableAutoHeight(),c.enableScale()):c.disableScale();!b.options.elementPathEnabled&&(!b.options.wordCount&&!b.options.scaleEnabled)&&(b.ui.getDom("elementpath").style.display="none",b.ui.getDom("wordcount").style.display="none",b.ui.getDom("scale").style.display="none");b.selection.isFocus()&&b.fireEvent("selectionchange",!1,!0)});b.addListener("mousedown",
function(a,b){q.editor.ui.Popup.postHide(b,b.target||b.srcElement)});b.addListener("delcells",function(){UE.ui.edittip&&new UE.ui.edittip(b);b.getDialog("edittip").open()});var d,e=!1,f;b.addListener("afterpaste",function(){b.queryCommandState("pasteplain")||(q.editor.ui.PastePicker&&(d=new q.editor.ui.Popup({content:new q.editor.ui.PastePicker({editor:b}),editor:b,className:"edui-wordpastepop"}),d.render()),e=!0)});b.addListener("afterinserthtml",function(){clearTimeout(f);f=setTimeout(function(){if(d&&
...
'</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("left") class="edui-clickable">'+b.getLang("justifyleft")+'</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("right") class="edui-clickable">'+b.getLang("justifyright")+'</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("center") class="edui-clickable">'+b.getLang("justifycenter")+"</span>&nbsp;&nbsp;<span onclick=\"$$._onImgEditButtonClick('"+g+'\');" class="edui-clickable">'+b.getLang("modify")+"</span></nobr>";!d&&(d=h.formatHtml(e))}if(b.ui._dialogs.linkDialog){var p=
b.queryCommandValue("link"),n;if(p&&(n=p.getAttribute("_href")||p.getAttribute("href",2)))e=n,30<n.length&&(e=n.substring(0,20)+"..."),d&&(d+='<div style="height:5px;"></div>'),d+=h.formatHtml("<nobr>"+b.getLang("anthorMsg")+': <a target="_blank" href="'+n+'" title="'+n+'" >'+e+'</a> <span class="edui-clickable" onclick="$$._onEditButtonClick();">'+b.getLang("modify")+'</span> <span class="edui-clickable" onclick="$$._onRemoveButtonClick(\'unlink\');"> '+b.getLang("clear")+"</span></nobr>"),h.showAnchor(p)}d?
(h.getDom("content").innerHTML=d,h.anchorEl=f||p,h.showAnchor(h.anchorEl)):h.hide()}}))},_initToolbars:function(){for(var a=this.editor,b=this.toolbars||[],c=[],d=0;d<b.length;d++){for(var e=b[d],f=new q.editor.ui.Toolbar({theme:a.options.theme}),h=0;h<e.length;h++){var j=e[h],l=null;if("string"==typeof j){if(j=j.toLowerCase(),"|"==j&&(j="Separator"),q.editor.ui[j]&&(l=new q.editor.ui[j](a)),"fullscreen"==j){c&&c[0]?c[0].items.splice(0,0,l):l&&f.items.splice(0,0,l);continue}}else l=j;l&&l.id&&f.add(l)}c[d]=
...
0});this.editor.setHeight(a.height-this.getDom("toolbarbox").offsetHeight-this.getDom("bottombar").offsetHeight-(this.editor.options.topOffset||0));if(p.gecko)window.onresize()}},_updateElementPath:function(){var a=this.getDom("elementpath"),b;if(this.elementPathEnabled&&(b=this.editor.queryCommandValue("elementpath"))){for(var c=[],d=0,e;e=b[d];d++)c[d]=this.formatHtml('<span unselectable="on" onclick="$$.editor.execCommand(&quot;elementpath&quot;, &quot;'+d+'&quot;);">'+e+"</span>");a.innerHTML=
...
k.offsetHeight);n.style.cssText="position:absolute;left:0;display:;top:0;background-color:#41ABFF;opacity:0.4;filter: Alpha(opacity=40);width:"+h.offsetWidth+"px;height:"+h.offsetHeight+"px;z-index:"+(f.options.zIndex+1);H.on(e,"mousemove",b);H.on(j,"mouseup",c);H.on(e,"mouseup",c)}function b(a){d();a=a||window.event;w=a.pageX||e.documentElement.scrollLeft+a.clientX;x=a.pageY||e.documentElement.scrollTop+a.clientY;y=w-t.x;r=x-t.y;y>=u&&(q=!0,n.style.width=y+"px");r>=s&&(q=!0,n.style.height=r+"px")}
function c(){q&&(q=!1,f.ui._actualFrameWidth=n.offsetWidth-2,h.style.width=f.ui._actualFrameWidth+"px",f.setHeight(n.offsetHeight-k.offsetHeight-l.offsetHeight-2));n&&(n.style.display="none");d();H.un(e,"mousemove",b);H.un(j,"mouseup",c);H.un(e,"mouseup",c)}function d(){p.ie?e.selection.clear():window.getSelection().removeAllRanges()}var e=document,f=this.editor,h=f.container,j=f.document,l=this.getDom("toolbarbox"),k=this.getDom("bottombar"),m=this.getDom("scale"),n=this.getDom("scalelayer"),q=!1,
