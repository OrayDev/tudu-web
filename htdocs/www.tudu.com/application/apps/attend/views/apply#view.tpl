...
<div class="panel">
    <div class="panel-body">
      <div id="float-toolbar" class="float-toolbar">
         <div class="toolbar">
         {{include file="apply#view^toolbar.tpl"}}
         </div>
      </div>
...
{{/if}}
        ...
        <div class="todo_content">
            ...
            <p><span class="icon icon_ext"></span><a href="javascript:void(0)" onclick="Tudu.View.toggleAttach('{{$tudu.tuduid}}')">{{$LANG.attachment}}</a>&nbsp;&nbsp;&nbsp;<span class="icon icon_log"></span><a href="javascript:void(0)" onclick="Tudu.View.toggleLog('{{$tudu.tuduid}}')">{{$LANG.log}}</a>&nbsp;&nbsp;&nbsp;<span class="icon icon_print"></span><a href="/tudu/print?tid={{$tudu.tuduid}}" target="_blank">{{$LANG.print}}</a>&nbsp;&nbsp;&nbsp;<span class="icon icon_order"></span>{{if !$isinvert}}<a href="/app/attend/apply/view?tid={{$tudu.tuduid}}{{if !$newwin}}&back={{$smarty.server.REQUEST_URI|urlencode}}{{/if}}&invert=1{{if $newwin}}&newwin=1{{/if}}">{{$LANG.invert_posts}}</a>{{else}}<a href="/app/attend/apply/view?tid={{$tudu.tuduid}}{{if !$newwin}}&back={{$smarty.server.REQUEST_URI|urlencode}}{{/if}}&invert=0{{if $newwin}}&newwin=1{{/if}}">{{$LANG.sequence_posts}}</a>{{/if}}{{if !$newwin}}&nbsp;&nbsp;&nbsp;<span class="icon icon_newwin"></span><a target="_blank" href="/app/attend/apply/view?tid={{$tudu.tuduid}}&newwin=1">{{$LANG.new_win}}</a>{{/if}}&nbsp;&nbsp;&nbsp;<span class="icon icon_edit_note"></span><a href="javascript:void(0)" onclick="Tudu.View.toggleNote('{{$tudu.tuduid}}')">{{$LANG.note}}</a></p>
        </div>
      </div>


      {{if count($steps) > 0}}
      {{include file="apply#view^step.tpl"}}
      {{/if}}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="todo_body">
          ...
          <tr>
            <td><div class="todo_body_con">
                ...
                {{include file="apply#view^profile.tpl"}}
...
<script src="{{$options.sites.static}}/js/attend/view.js?1008" type="text/javascript"></script>
...
$(function(){
    ...
    Tudu.View.applyId = "{{$apply.applyid}}";
