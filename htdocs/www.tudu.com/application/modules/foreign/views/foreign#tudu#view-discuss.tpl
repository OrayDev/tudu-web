          ...
          <tr>
            <td><div class="todo_body_con">
                ...
                <div id="vote-{{$vote.voteid}}">
                    <form name="voteform" id="voteform-{{$vote.voteid}}" action="/foreign/tudu-mgr/vote" method="post">
                        ...
                        <tr>
                          <td colspan="3">
                            ...
                            {{*<span class="vote-privacy"{{if !$vote.isvoted || !$vote.privacy}} style="display:none;"{{/if}}>{{$LANG.comma}}<a href="javascript:void(0)" class="view-voter" _voteid="{{$vote.voteid}}">{{$LANG.view_vote_info}}</a></span>*}}
                          </td>
                        </tr>
                        ...
                        {{if $vote.enabled && !$tudu.isdone}}
                        <tr>
                          <td colspan="3"><button type="submit" class="btn">{{$LANG.vote_now}}</button><span class="vote-info gray"></span></td>
                        </tr>
                        {{else}}
                        <tr>
                            <td colspan="3">
