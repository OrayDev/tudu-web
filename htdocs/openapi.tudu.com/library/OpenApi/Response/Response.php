...
/**
 * @see OpenApi_Response_Formatter_Interface
 */
require_once "OpenApi/Response/Formatter/Interface.php";
 ...
 * @copyright  Copyright (c) 2009-2010 Shanghai Best Oray Information S&T CO., Ltd.
 */
class OpenApi_Response_Response implements Zend_View_Interface
{
    ...
    /**
     *
     * @var OpenApi_Response_Formatter_Interface
     */
     ...
     * @return void
     */
    public function setBasePath($path, $classPrefix = 'OpenApi_Response')
    {
     ...
     * @return void
     */
    public function addBasePath($path, $classPrefix = 'OpenApi_Response')
    {
        $this->_options[self::OPT_BASE_PATH][] = array(
    ...
    public function assign($spec, $value = null)
    {
        ...
        /**
         * @see OpenApi_Response_Exception
         */
        require_once 'OpenApi/Response/Exception.php';
        throw new OpenApi_Response_Exception("Invalid params of spec for assign method");
    }
    ...
    {
        $className = 'OpenApi_Response_Formatter_' . ucfirst($format);
