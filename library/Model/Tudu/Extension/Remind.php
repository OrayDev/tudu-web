 ...
 */
class Model_Tudu_Extension_Remind extends Model_Tudu_Extension_Abstract
{
    /**
     *
     * @var string
     */
    protected $_handlerClass = 'Model_Tudu_Extension_Handler_Remind';
     ...
     * @param string $key
     * @param mixed  $value
     * @return Model_Tudu_Extension_Remind
     */
